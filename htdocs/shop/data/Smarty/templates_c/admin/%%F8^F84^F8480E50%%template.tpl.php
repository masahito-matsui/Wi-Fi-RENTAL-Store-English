<?php /* Smarty version 2.6.27, created on 2022-08-24 12:35:46
         compiled from mail/template.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail/template.tpl', 4, false),array('modifier', 'date_format', 'mail/template.tpl', 15, false),array('modifier', 'h', 'mail/template.tpl', 15, false),)), $this); ?>
...
"><div class="btn">
    ...
    <div id="mail" class="contents-main">
        <table class="list center"><col width="15%"><col width="35%"><col width="20%"><col width="10%"><col width="10%"><col width="10%"><tr><th>作成日</th>
                <th>subject</th>
                <th>メール形式</th>
                <th>編集</th>
                <th>削除</th>
