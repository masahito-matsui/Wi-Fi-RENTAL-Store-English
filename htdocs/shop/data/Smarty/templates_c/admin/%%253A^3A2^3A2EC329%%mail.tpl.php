<?php /* Smarty version 2.6.27, created on 2021-10-22 18:20:25
         compiled from basis/mail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/mail.tpl', 27, false),array('modifier', 'sfGetErrorColor', 'basis/mail.tpl', 34, false),array('modifier', 'h', 'basis/mail.tpl', 41, false),array('function', 'html_options', 'basis/mail.tpl', 34, false),)), $this); ?>
...
"><input type="hidden" name="mode" value="regist"><div id="basis" class="contents-main">
        <table><tr><th>テンプレート<span class="attention"> *</span></th>
                <td>
...
文字)
                ...
                <div>
                    ...
                    今までに入力したのは
                    <input type="text" name="cnt_header" size="4" class="box4" readonly style="text-align:right">
                    文字です。
                </div>
                </td>
            </tr><tr><th colspan="2" align="center">動的データ挿入部分</th>
            </tr><tr><th>フッター</th>
                <td>
...
文字)</span>
                <div>
                    ...
                    今までに入力したのは
                    <input type="text" name="cnt_footer" size="4" class="box4" readonly style="text-align:right">
                    文字です。
                </div>
                </td>
            </tr></table><div class="btn-area">
            <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('form1', 'regist', '', ''); return false;"><span class="btn-next">この内容で登録する</span></a></li>
            </ul></div>
    </div>
</form>