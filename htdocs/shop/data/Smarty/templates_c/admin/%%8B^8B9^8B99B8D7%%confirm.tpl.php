<?php /* Smarty version 2.6.27, created on 2023-11-29 18:08:15
         compiled from basis/confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/confirm.tpl', 4, false),array('modifier', 'h', 'basis/confirm.tpl', 4, false),)), $this); ?>
...
"><?php endif; ?><?php endforeach; endif; unset($_from); ?><h2>基本情報</h2>
    <table><tr><th>会社名</th>
            <td>
...
<?php else: ?>未登録<?php endif; ?></td>
        ...
        </tr><tr><th>問い合わせ受付<br>メールアドレス</th>
            <td>
        ...
        </tr><tr><th>送信エラー受付<br>メールアドレス</th>
            <td>
...
日間有効
	...
	<table><tr><th>緯度</th>
        ...
        <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.setModeAndSubmit('return','',''); return false;"><span class="btn-prev">前のページに戻る</span></a></li>
