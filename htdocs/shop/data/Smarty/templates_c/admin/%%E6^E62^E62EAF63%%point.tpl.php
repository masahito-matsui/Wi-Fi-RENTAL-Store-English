<?php /* Smarty version 2.6.27, created on 2022-04-10 11:26:59
         compiled from basis/point.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/point.tpl', 4, false),array('modifier', 'h', 'basis/point.tpl', 11, false),array('modifier', 'sfGetErrorColor', 'basis/point.tpl', 11, false),)), $this); ?>
...
"><div id="basis" class="contents-main">
        <table><tr><th>ポイント付与率（初期値）<span class="attention"> *</span></th>
                <td>
...
" size="6" class="box6">
                    ％　小数点以下切り捨て</td>
            </tr><tr><th>会員登録時付与ポイント<span class="attention"> *</span></th>
                <td>
...
" size="6" class="box6">
            ...
            <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('point_form', '<?php echo ((is_array($_tmp=$this->_tpl_vars['tpl_mode'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
