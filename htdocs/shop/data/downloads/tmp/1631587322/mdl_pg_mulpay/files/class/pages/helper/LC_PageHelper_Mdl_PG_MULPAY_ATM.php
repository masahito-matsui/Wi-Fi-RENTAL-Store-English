...
// {{{ requires
require_once(MDL_PG_MULPAY_PAGE_HELPEREX_PATH . 'LC_PageHelper_Mdl_PG_MULPAY_PayEasy_Ex.php');
 ...
 */
class LC_PageHelper_Mdl_PG_MULPAY_ATM extends LC_PageHelper_Mdl_PG_MULPAY_PayEasy_Ex {
    ...
    function getFormBloc() {
        ...
        $bloc_id =  $arrBlocId['pg_mulpay_atm'][ $device_type_id ];
        if ($bloc_id) {
