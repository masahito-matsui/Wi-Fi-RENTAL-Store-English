...
<section id="mypagecolumn">
    ...
    <form name="form1" id="form1" method="post" action="<!--{$smarty.const.HTTPS_URL}-->mypage/change.php">
        ...
        <div class="btn_area">
            <ul class="btn_btm">
                <li><input type="submit" value="Update" class="btn data-role-none" name="complete" id="complete" /></li>
                <li><a class="btn_back" href="Javascript:eccube.setModeAndSubmit('return', '', '');" rel="external">Back</a></li>
            </ul>
        </div>
    </form>
</section>
