...
//        }
    ...
    public function lfSendMail($uniqid, $arrForm)
    {
        ...
        if (CUSTOMER_CONFIRM_MAIL == true) {
            ...
            $subject        = $objHelperMail->sfMakeSubject('Membership registration has been completed');
    ...
    public function lfCheckError($arrRequest)
    {
        ...
        $objFormParam = new SC_FormParam_Ex();
        // パラメーター情報の初期化
        $objFormParam->addParam('ZIP CODE1', 'zip01', ZIP01_LEN, 'n', array('EXIST_CHECK', 'NUM_COUNT_CHECK', 'NUM_CHECK'));
        $objFormParam->addParam('ZIP CODE2', 'zip02', ZIP02_LEN, 'n', array('EXIST_CHECK', 'NUM_COUNT_CHECK', 'NUM_CHECK'));
        // // リクエスト値をセット
