...
//        }
    ...
    {
		//自宅・その他/延長利用
		if(($_SESSION['pre_deliv_id'] == 1) || ($_SESSION['pre_deliv_id'] == 5) || ($_SESSION['pre_deliv_id'] == 8) || ($_SESSION['pre_deliv_id'] == 9) || ($_SESSION['pre_deliv_id'] == "")) {
			$objFormParam->addParam('Name ', $prefix . 'name01', STEXT_LEN, 'aKV', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK', 'ALNUM_CHECK'));
			$objFormParam->addParam('Name ', $prefix . 'name02', STEXT_LEN, 'aKV', array('NO_SPTAB', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
			if($_SESSION['pre_deliv_id'] == 5) {
			$objFormParam->addParam('Terminal number ', $prefix . 'company_name', STEXT_LEN, 'aKV', array('EXIST_CHECK', 'MAX_LENGTH_CHECK', 'SPTAB_CHECK'));
			} else {
			...
			if (FORM_COUNTRY_ENABLE === false) {
				...
				if(($_SESSION['pre_deliv_id'] == 1 || $_SESSION['pre_deliv_id'] == 9) && ($prefix == 'shipping_')) {
				$objFormParam->addParam('Post Code1 ', $prefix . 'zip01', ZIP01_LEN, 'n', array('EXIST_CHECK', 'SPTAB_CHECK' ,'NUM_CHECK', 'NUM_COUNT_CHECK'));
				$objFormParam->addParam('Post Code2 ', $prefix . 'zip02', ZIP02_LEN, 'n', array('EXIST_CHECK', 'SPTAB_CHECK' ,'NUM_CHECK', 'NUM_COUNT_CHECK'));
				} else {
				...
				if(($_SESSION['pre_deliv_id'] == 1 || $_SESSION['pre_deliv_id'] == 9) && ($prefix == 'shipping_')) {
				$objFormParam->addParam('prefectures ', $prefix . 'pref', INT_LEN, 'n', array('EXIST_CHECK','NUM_CHECK'));
				} else {
...
/*
				...
				$objFormParam->addParam('郵便番号2', $prefix . 'zip02', ZIP02_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'NUM_COUNT_CHECK'));
				$objFormParam->addParam('国', $prefix . 'country_id', INT_LEN, 'n', array('NUM_CHECK'));
				$objFormParam->addParam('Post Code', $prefix . 'zipcode', STEXT_LEN, 'n', array('NO_SPTAB', 'SPTAB_CHECK', 'GRAPH_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('prefectures ', $prefix . 'pref', INT_LEN, 'n', array('EXIST_CHECK', 'NUM_CHECK'));
*/
			}
			$objFormParam->addParam('Address1', $prefix . 'addr01', MTEXT_LEN, 'aKV', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
			$objFormParam->addParam('Address2', $prefix . 'addr02', MTEXT_LEN, 'aKV', array('SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
			$objFormParam->addParam('Phone number', $prefix . 'tel01', TEL_ITEM_LEN, 'n', array('EXIST_CHECK', 'SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
			$objFormParam->addParam('Phone number2', $prefix . 'tel02', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
			$objFormParam->addParam('Phone number3', $prefix . 'tel03', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
		...
		//空港受取/店舗受け取り
		} else if(($_SESSION['pre_deliv_id'] == 3) || ($_SESSION['pre_deliv_id'] == 4)) {
			//order
			if ($prefix == 'order_') {
				$objFormParam->addParam('Name ', $prefix . 'name01', STEXT_LEN, 'aKV', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK', 'ALNUM_CHECK'));
				$objFormParam->addParam('Name ', $prefix . 'name02', STEXT_LEN, 'aKV', array('NO_SPTAB', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
				...
				$objFormParam->addParam('Address1', $prefix . 'addr01', MTEXT_LEN, 'aKV', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('Address2', $prefix . 'addr02', MTEXT_LEN, 'aKV', array('SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('Phone number', $prefix . 'tel01', TEL_ITEM_LEN, 'n', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('Phone number2', $prefix . 'tel02', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('Phone number3', $prefix . 'tel03', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('FAX番号1', $prefix . 'fax01', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('FAX番号2', $prefix . 'fax02', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
			...
			//shipping
				...
				$objFormParam->addParam('Address1', $prefix . 'addr01', MTEXT_LEN, 'aKV', array('SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('Address2', $prefix . 'addr02', MTEXT_LEN, 'aKV', array('SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('Phone number', $prefix . 'tel01', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('Phone number2', $prefix . 'tel02', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('Phone number3', $prefix . 'tel03', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('FAX番号1', $prefix . 'fax01', TEL_ITEM_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
				$objFormParam->addParam('FAX番号2', $prefix . 'fax02', TEL_ITEM_LEN, 'n', array('MAX_LENGTH_CHECK'));
				$objFormParam->addParam('FAX番号3', $prefix . 'fax03', TEL_ITEM_LEN, 'n', array('MAX_LENGTH_CHECK'));
			}
		}
      $objFormParam->addParam('start_date', 'start_date', STEXT_LEN, 'n', array('MAX_LENGTH_CHECK'));
      $objFormParam->addParam('end_date', 'end_date', STEXT_LEN, 'n', array('MAX_LENGTH_CHECK'));
      $objFormParam->addParam('rental_term', 'rental_term', STEXT_LEN, 'n', array('MAX_LENGTH_CHECK'));
      $objFormParam->addParam('rental_flg', 'rental_flg', STEXT_LEN, 'n', array('MAX_LENGTH_CHECK'));
      $objFormParam->addParam('extension_flg', 'extension_flg', STEXT_LEN, 'n', array('MAX_LENGTH_CHECK'));
      $objFormParam->addParam('receive_flg', 'receive_flg', STEXT_LEN, 'n', array('MAX_LENGTH_CHECK'));
    ...
    {
        $objFormParam->addParam('Password', $prefix . 'password', PASSWORD_MAX_LEN, '', array('EXIST_CHECK', 'SPTAB_CHECK', 'ALNUM_CHECK'));
        $objFormParam->addParam('Answer', $prefix . 'reminder_answer', STEXT_LEN, '', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('Question', $prefix . 'reminder', STEXT_LEN, 'n', array('EXIST_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));
        ...
        if (SC_Display_Ex::detectDevice() !== DEVICE_TYPE_MOBILE) {
            $objFormParam->addParam('Email address', $prefix . 'email', null, 'a', array('NO_SPTAB', 'EXIST_CHECK', 'EMAIL_CHECK', 'SPTAB_CHECK' ,'EMAIL_CHAR_CHECK'));
            $objFormParam->addParam('Password(confirm)', $prefix . 'password02', PASSWORD_MAX_LEN, '', array('EXIST_CHECK', 'SPTAB_CHECK' ,'ALNUM_CHECK'), '', false);
            if (!$isAdmin) {
                $objFormParam->addParam('Email address (confirm)', $prefix . 'email02', null, 'a', array('NO_SPTAB', 'EXIST_CHECK', 'EMAIL_CHECK','SPTAB_CHECK' , 'EMAIL_CHAR_CHECK'), '', false);
            }
        } else {
            if (!$is_mypage) {
                $objFormParam->addParam('Email address', $prefix . 'email', null, 'a', array('EXIST_CHECK', 'EMAIL_CHECK', 'NO_SPTAB' ,'EMAIL_CHAR_CHECK', 'MOBILE_EMAIL_CHECK'));
            }
        }
    }
    ...
    public function sfCustomerEntryErrorCheck(&$objFormParam)
    {
        ...
        if ($objCustomer->isLoginSuccess(true)
            ...
            $objErr->arrErr['email'] .= '※ This email address has been already used as membership registration.<br />';
        }
        if ($objCustomer->isLoginSuccess(true)
            ...
            $objErr->arrErr['email_mobile'] .= '※This email address has been already used as membership registration.<br />';
        }
...
//        $objErr->doFunc(array('Phone', $prefix . 'tel01', $prefix . 'tel02', $prefix . 'tel03'),array('TEL_CHECK'));
        $objErr->doFunc(array('FAX番号', $prefix . 'fax01', $prefix . 'fax02', $prefix . 'fax03') ,array('TEL_CHECK'));
        $objErr->doFunc(array('Post Code', $prefix . 'zip01', $prefix . 'zip02'), array('ALL_EXIST_CHECK'));
    ...
    public function sfCustomerRegisterErrorCheck(&$objErr, $isAdmin = false)
    {
        ...
        $objErr->doFunc(array('Password', 'password', PASSWORD_MIN_LEN, PASSWORD_MAX_LEN) ,array('NUM_RANGE_CHECK'));

        if (SC_Display_Ex::detectDevice() !== DEVICE_TYPE_MOBILE) {
            if (!$isAdmin) {
                $objErr->doFunc(array('E-mail', 'E-mail(confirm)', 'email', 'email02') ,array('EQUAL_CHECK'));
            }
            $objErr->doFunc(array('Password', 'Password(confirm)', 'password', 'password02') ,array('EQUAL_CHECK'));
        }
