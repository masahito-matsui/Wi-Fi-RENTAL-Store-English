<?php /* Smarty version 2.6.27, created on 2024-10-11 11:09:27
         compiled from ownersstore/settings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'ownersstore/settings.tpl', 4, false),array('modifier', 'sfGetErrorColor', 'ownersstore/settings.tpl', 12, false),array('modifier', 'h', 'ownersstore/settings.tpl', 12, false),)), $this); ?>
...
" target="_blank">EC-CUBEオーナーズストア</a>で取得できます。</span></p>
        <table class="form"><tr><th>認証キーの設定</th>
                <td>
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
            ...
            </tr></table><!--入力項目ここまで--><!--登録ボタンここから--><div class="btn-area">
            <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('form1', 'register', '', ''); return false;"><span class="btn-next">この内容で登録する</span></a></li>
            </ul></div>
        <!--登録ボタンここまで-->
