	...
	if($quantity > 2) {
      ...
      if($bsim_flg == 0) {
        ...
        switch ($this->mode) {
            case 'confirm':
				//配送方法をセッションに保存
				if($_REQUEST['deliv_id'] > 0) {
					$_SESSION['pre_deliv_id'] = $_REQUEST['deliv_id'];
				}
                // カート内情報の取得
