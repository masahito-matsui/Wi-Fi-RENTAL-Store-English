...
<h3>Pickup Method</h3>
<div class="text001 only_ext">
<input type="radio" name="deliv_id" id="airport" value="3">
<label for="airport" class="method_name">Pickup at Airport</label>
<p class="method_text">For airport pickup, there is a 540 yen surcharge in addition to the round-trip postage of 1,080 yen.<br><span class="s_text">Please enter your flight number and the estimated time of arrival in the remarks field on the next page.</span></p>
</div>
<div class="text001 only_ext">
<input type="radio" name="deliv_id" id="normal" value="1">
<label for="normal" class="method_name">Hotels, Your Place of Stay (Airbnb, friend's house, etc)</label>
<p class="method_text">Item is delivered by the delivery services (Yamato Transport services or Japan Post).</p>
</div>
<div class="line001"></div>
<div class="text001 only_ext">
<input type="radio" name="deliv_id" id="storefront" value="4">
<label for="storefront" class="method_name">In-Store Pickup</label>
<p class="method_text">5 minutes on foot from Akihabara station. Business hours: 9:30AM to 6:30PM (Weekdays) / 11AM to 6PM (Weekends).<br>
In weekends or holidays, only Japanese speaking staff may be available.<br>
...
<label for="extension" class="method_name">Rental ExteOrder for extension of rental</label>
<p class="method_text">*This is for our consumers who are using right now.</p>
</div>
<div class="text001 only_ext2">
<input type="radio" name="deliv_id" id="extension2" value="5" checked disabled>
<label for="extension2" class="method_name">Rental Extension</label>
<p class="method_text">This is to extend your current rental period.</p>
</div>
<p id="deliv_radio" class="nodisp attention">Please select the pickup method.</p>
</div>
...
function checkDeliver() {
	...
	if((airport != true) && (normal != true) && (storefront != true) && (extension != true) && (extension2 != true)) {
		...
		$("#terms_attention").removeClass("nodisp");
	} else {
...
<!--{php}-->}<!--{/php}-->
                            ...
                            <div><span class="mini">Additional delivery fee：</span><span id="add_charge"></span></div>
...
<p id="terms_attention" class="nodisp attention">Please consent to the Terms and Conditions.</p>
</div>
　
　　<div class="link_box">
