    ...
    <!--{if $flgFields > 1}-->
        <tr>
            ...
            <td>
                ...
                <span class="mini">Re-enter email address</span>
            </td>
        </tr>
<!--{if false}-->
        <!--{if $emailMobile}-->
...
<!--{/if}-->
    ...
    <tr>
        <th>[Those who order more than one router]<br />
...
<!--			<option value="0" selected="selected">選択してください</option>-->
        ...
        <tr>
        <th>Terminal number<span class="attention">※</span></th>
        <td>
         ...
         Pleae key in present terminal number that begins with EM- LN- WM-</span>   
        </td>
			<!--{/if}-->
    </tr>
        <!--{/if}-->
        ...
        <!--{if $flgFields > 2}-->
            <tr>
                <th>Password<span class="attention"></span><br />
                </th>
                <td>
                    ...
                    <p><span class="mini">Minimum 4 characters   * Numbers are allowed</span></p>
                    ...
                    <p><span class="mini">Re-enter password</span></p>
                </td>
            </tr>
            <tr>
                <th>Password hint<span class="attention"></span></th>
                <td>
                    ...
                    <br />
                    A：<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->; ime-mode: disabled;" class="box260" />
                </td>
            </tr>
        <!--{if false}-->
            <tr>
