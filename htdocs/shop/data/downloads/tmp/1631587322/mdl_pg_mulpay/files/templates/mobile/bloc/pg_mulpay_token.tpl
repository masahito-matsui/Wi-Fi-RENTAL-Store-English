...
<script type="text/javascript">
    ...
    function execPurchase(response) {
        if (response.resultCode != 000) {
            ...
            elements = document.getElementsByName("Method");
            for (var i = 0; i < elements.length; ++i) {
                elements[i].value = document.getElementById("Method").value;
            }
    ...
    function doPurchase() {
        ...
        <!--{if !$tpl_is_loading}-->
            ...
            <hr>
                    ...
                    <!--{/if}-->
                    <input type="text" id="<!--{$key1}-->" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" istyle="3" size="16" />
                    <br>
                    <br>
                    ...
                    <!--{/if}-->
                        ...
                        名:<input type="text" id="<!--{$key1}-->" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" istyle="3" size="20"  />
                        <br>
                        姓:<input type="text" id="<!--{$key2}-->" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$arrForm[$key2].length}-->" istyle="3" size="20"  />
                        <br>
                ...
                <!--{if $arrPaymentInfo.use_securitycd == '1'}-->
                    ...
                    <!--{/if}-->
                        <input type="text" id="<!--{$key}-->" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|h}-->" maxlength="<!--{$arrForm[$key].length}-->" istyle="3" size="4" />
                        <br>
        ...
        <center><input type="button" id="next" value="次へ" onclick="doPurchase(); return false;"></center>
    ...
    <form action="?mode=return" method="get">
        ...
        <center><input type="submit" id="back" value="戻る"></center>
    </form>
<!--{/strip}-->
