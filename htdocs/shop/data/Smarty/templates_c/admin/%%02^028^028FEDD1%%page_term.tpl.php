<?php /* Smarty version 2.6.27, created on 2021-09-24 02:08:34
         compiled from total/page_term.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'total/page_term.tpl', 13, false),array('modifier', 'number_format', 'total/page_term.tpl', 18, false),)), $this); ?>


<table id="total-term" class="list"><tr><th>期間</th>
        <th>購入件数</th>
        <th>男性</th>
        <th>女性</th>
        <th>男性(会員)</th>
...
?><?php if (! ((is_array($_tmp=$this->_sections['cnt']['last'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><?php $this->assign('type', ($this->_sections['cnt']['index']%2)); ?><?php if (((is_array($_tmp=$this->_tpl_vars['type'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 0): ?><?php $this->assign('color', 'even'); ?><?php else: ?><?php $this->assign('color', 'odd'); ?><?php endif; ?><?php else: ?><?php $this->assign('color', 'last'); ?><?php endif; ?><tr class="<?php echo ((is_array($_tmp=$this->_tpl_vars['color'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><?php $this->assign('wday', ($this->_tpl_vars['arrResults'][$this->_sections['cnt']['index']]['wday'])); ?><?php if (! ((is_array($_tmp=$this->_sections['cnt']['last'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><td class="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrResults'][$this->_sections['cnt']['index']]['str_date'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</td>
            <?php else: ?>
...
円</td>
        </tr><?php endfor; endif; ?><tr><th>期間</th>
        <th>購入件数</th>
        <th>男性</th>
        <th>女性</th>
        <th>男性(会員)</th>
