...
<section id="mypagecolumn">
    ...
    <!--{if $tpl_linemax > 0}-->
        ...
        <div class="information">
            <p>There is  <span class="attention"><span id="productscount"><!--{$tpl_linemax}--></span></span>favorite</p>
        </div>
            ...
            <form name="form1" id="form1" method="post" action="<!--{$smarty.const.ROOT_URLPATH}-->mypage/favorite.php">
                ...
                <!--{if $stock_find_count > 0 && $customer_rank < 51}-->
                    <div class="product-btn">
                        <a rel="external" href="javascript:void(document.form1.submit())" class="btn-cart">Add to cart</a>
                    </div>
                <!--{/if}-->
            </form>
        </div><!-- /.form_area -->
        ...
        <div class="btn_area">
            <!--{if $tpl_linemax > $dispNumber}-->
                <p><a rel="external" href="javascript: void(0);" class="btn_more" id="btn_more_product" onclick="getProducts(<!--{$dispNumber}-->); return false;">More(＋<!--{$dispNumber}-->)</a></p>
            <!--{/if}-->
        </div>
    ...
    <!--{else}-->
        <div class="form_area">
            <div class="information">
                <p>Favorite is not registered.</p>
            </div>
        </div><!-- /.form_area -->
    <!--{/if}-->
