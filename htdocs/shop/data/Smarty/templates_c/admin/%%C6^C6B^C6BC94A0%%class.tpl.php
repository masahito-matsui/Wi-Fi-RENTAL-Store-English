<?php /* Smarty version 2.6.27, created on 2021-10-12 18:09:24
         compiled from products/class.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/class.tpl', 4, false),array('modifier', 'h', 'products/class.tpl', 4, false),array('modifier', 'sfGetErrorColor', 'products/class.tpl', 11, false),array('modifier', 'default', 'products/class.tpl', 22, false),)), $this); ?>


<form name="form1" id="form1" method="post" action="?">
    <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value="edit"><input type="hidden" name="class_id" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['tpl_class_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
"><div id="products" class="contents-main">

        <table><tr><th>規格名<span class="attention"> *</span></th>
                <td>
...
" size="30" class="box30"><span class="attention"> (上限<?php echo ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
                </td>
        ...
        <table class="list"><col><col width="15%"><col width="10%"><col width="10%"><col width="15%"><tr><th>規格名 (登録数)</th>
                <th>分類登録</th>
                <th class="edit">編集</th>
...
<?php endif; ?>;"><?php $this->assign('class_id', ((is_array($_tmp=$this->_tpl_vars['arrClass'][$this->_sections['cnt']['index']]['class_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))); ?><td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrClass'][$this->_sections['cnt']['index']]['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
