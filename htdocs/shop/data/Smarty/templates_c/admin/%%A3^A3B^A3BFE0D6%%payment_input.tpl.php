...
"><input type="hidden" name="image_key" value=""><input type="hidden" name="fix" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrForm']['fix']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
"><?php endforeach; endif; unset($_from); ?><input type="hidden" name="charge_flg" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['charge_flg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" />                    <span class="attention">（半角英数18文字以内で入力）</span>
	      ...
	      <td>
              <?php if (((is_array($_tmp=$this->_tpl_vars['plg_pg_mulpay_payid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == MDL_PG_MULPAY_PAYID_REGIST_CREDIT): ?>
                <span class="attention">※入力回数制限については、トークン方式クレジットカードまたはクレジットカードに設定をお願いいたします。</span>
              <?php else: ?>
		<?php $this->assign('key', 'use_limit'); ?>
		<span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                <?php echo smarty_function_html_radios(array('name' => ((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['keyname'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'options' => ((is_array($_tmp=$this->_tpl_vars['arrEnableFlags'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'separator' => "&nbsp;"), $this);?>
...
"
		       ...
		       value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
"
		       maxlength="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['length'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">分
		<span style="font-size:80%"><br />
		  ※入力回数制限を利用しない場合、入力は不要です。<br />
		  ※指定した検出時間内に決済エラーが発生した場合、エラー回数を加算します。
		</span>
	      </td>
	    </tr>
            <tr>
	      ...
	      <td>
		<?php $this->assign('key', 'limit_count'); ?>
		<span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
		<input id="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"
...
">回
		<span style="font-size:80%"><br />
		  ※入力回数制限を利用しない場合、入力は不要です。<br />
		  ※指定したエラー上限回数に達した場合、クレジットロック画面を表示します。
		</span>
	      </td>
	    </tr>
            <tr>
