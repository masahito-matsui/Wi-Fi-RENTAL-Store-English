...
require_once PLUGIN_UPLOAD_REALDIR . "ExpressLink/class/plg_ExpressLink_LC_Page_Admin_Order_Edit.php";

class plg_ExpressLink_LC_Page_Admin_Order_Edit_Ex extends plg_ExpressLink_LC_Page_Admin_Order_Edit
{
