<?php /* Smarty version 2.6.27, created on 2023-02-14 14:40:03
         compiled from contents/recommend.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'contents/recommend.tpl', 30, false),array('modifier', 'h', 'contents/recommend.tpl', 30, false),array('modifier', 'sfNoImageMainList', 'contents/recommend.tpl', 77, false),array('modifier', 'sfGetErrorColor', 'contents/recommend.tpl', 85, false),array('modifier', 'sfGetEnabled', 'contents/recommend.tpl', 85, false),)), $this); ?>
...
?>
    <div class="recommend-product <?php if (((is_array($_tmp=$this->_tpl_vars['arrItems'][$this->_sections['cnt']['iteration']]['status'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '2'): ?>hidden<?php endif; ?>">
        <table class="list center recommend-table"><col width="13%"><col width="73%"><col width="7%"><col width="7%"><tr><th>順位</th>
                <th>商品/コメント</th>
                <th>編集</th>
                <th>削除</th>
                <th>並び替え</th>
            </tr><tr><td>おすすめ商品(<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
)</td>
...
" width="100" height="100"><?php endif; ?></div>
...
"><input type="hidden" name="mode" value="regist"><input type="hidden" name="best_id" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrItems'][$this->_sections['cnt']['iteration']]['best_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
