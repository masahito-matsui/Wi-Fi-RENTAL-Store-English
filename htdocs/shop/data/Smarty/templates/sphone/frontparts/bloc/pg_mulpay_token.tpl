...
*/
        ...
        <section id="payment_form_td_tran" style="<!--{if !$tpl_is_td_tran}-->display:none;<!--{/if}-->">
            ...
            <div class="bubbleBox hot">
                ...
                <div class="information end">
                    <span class="attention">※It may take a little time to switch screen, please just a morment</span>
                </div>
            </div>
            <div class="bubbleBox hot">
                <div class="bubble_announce clearfix">
        ...
        <section id="payment_form_body" style="<!--{if $tpl_is_loding}-->display:none;<!--{/if}-->">
            <div class="information end">
                <p>Please fill in the following form.　Please note that all fields followed by mark of「<span class="attention">※</span>」must be filled in.　 Please crick the bottom button “payment”</p>
                <!--{assign var=key value="payment"}-->
                <p class="attention"><!--{$arrErr[$key]}--></p>
            </div>
                <h3 class="subtitle">Entry form of credit card</h3>
                <dl class="form_entry">
                    <dt>
                    ...
                    <dd>
                        ...
                        <span class="attention"><!--{$arrErr[$key1]}--></span>
                        <span class="attention"><!--{$arrErr[$key2]}--></span>
                        <input type="hidden" id="<!--{$key1}-->" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="ime-mode: disabled; <!--{$arrErr[$key1]|sfGetErrorColor}-->" size="20" class="box120" />
                        <!--&nbsp;-->
                        <input type="text" id="<!--{$key2}-->" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$arrForm[$key2].length}-->" style="ime-mode: disabled; <!--{$arrErr[$key2]|sfGetErrorColor}-->" size="20" class="box120" />
            ...
            <div class="btn_area">
                <ul class="btn_btm">
                        ...
                        <!--{if $tpl_btn_next}-->
                            <a rel="external" href="javascript:void(fnCheckSubmit('next'));" class="btn"/>次へ</a>
                        <!--{else}-->
                            <a rel="external" id="next" href="javascript:void(doPurchase());" class="btn"/>Payment</a>
                        <!--{/if}-->
                        </li>

                        <!--{if !$tpl_btn_next}-->
                        <li>
                            <a rel="external" id="back" href="javascript:void(fnCheckSubmit('return'));" class="btn_back"/>Return</a>
                        </li>
                        <!--{/if}-->
                </ul>
            </div>
