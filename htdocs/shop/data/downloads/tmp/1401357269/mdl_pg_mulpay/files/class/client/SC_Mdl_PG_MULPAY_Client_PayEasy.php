 ...
 */
class SC_Mdl_PG_MULPAY_Client_PayEasy extends SC_Mdl_PG_MULPAY_Client_Base_Ex {
    ...
    function doPaymentRequest($arrOrder, $arrParam, $arrPaymentInfo) {
        ...
        $server_url = $arrMdlSetting['server_url'] . 'EntryTranPayEasy.idPass';
        ...
        $server_url = $arrMdlSetting['server_url'] . 'ExecTranPayEasy.idPass';
        $arrSendKey = array(
            'AccessID',
            'AccessPass',
            'OrderID',
