<?php /* Smarty version 2.6.27, created on 2022-01-25 11:11:44
         compiled from ownersstore/plugin.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'ownersstore/plugin.tpl', 97, false),array('modifier', 'sfGetErrorColor', 'ownersstore/plugin.tpl', 103, false),array('modifier', 'h', 'ownersstore/plugin.tpl', 103, false),array('modifier', 'default', 'ownersstore/plugin.tpl', 121, false),)), $this); ?>
...
"><input type="hidden" name="mode" value=""><input type="hidden" name="plugin_id" value=""><input type="hidden" name="plugin_code" value=""><input type="hidden" name="priority" value=""><div id="system" class="contents-main">
        <h2>プラグイン登録</h2>
        <table class="form"><tr><th>プラグイン<span class="attention"> *</span></th>
                <td>
...
<?php endif; ?>"><a class="btn-action" href="javascript:;" onclick="install(); return false;"><span class="btn-next">インストール</span></a>
                </td>
            </tr></table><!--▼プラグイン一覧ここから--><h2>プラグイン一覧</h2>
        <?php if (count ( ((is_array($_tmp=$this->_tpl_vars['plugins'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?>
            ...
            <table class="system-plugin" width="900"><col width="10%"><col width="77"><col width="13%"><tr><th colspan="2">機能説明</th>
                    <th>優先度</th>
...
?><?php $this->assign('plugin', ((is_array($_tmp=$this->_tpl_vars['plugins'][$this->_sections['data']['index']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))); ?><tr <?php if (((is_array($_tmp=$this->_tpl_vars['plugin']['enable'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == ((is_array($_tmp=@PLUGIN_ENABLE_FALSE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?> style="background:#C9C9C9;" <?php endif; ?>><!--ロゴ--><td class="center plugin_img">
...
" width="65" height="65"><?php endif; ?></td>
                    <!--機能説明-->
...
','author_site_url','620','760',{menubar:'no'}); return false;"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['plugin']['author'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, '-') : smarty_modifier_default($_tmp, '-')))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                            <br><!-- 説明 --><p class="description"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['plugin']['plugin_description'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, '-') : smarty_modifier_default($_tmp, '-')))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</p>
                            <div>
...
</span><br><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['plugin']['plugin_code']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                                <!-- 設定 -->
...
" checked>有効</label><br><?php else: ?><label><input id="plugin_enable" type="checkbox" name="enable" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']['plugin_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
">有効にする</label><br><?php endif; ?><!-- アップデートリンク押下時に表示する. --><div id="plugin_update_<?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']['plugin_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" style="display: none">
...
" class="box30" size="30" <?php if (((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?> <?php endif; ?>><a class="btn-action" href="javascript:;" onclick="update(<?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']['plugin_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
, '<?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']['plugin_code'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" size="1"><a class="btn-action" href="javascript:;" onclick="update_priority(<?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']['plugin_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
, '<?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']['plugin_code'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;"><span class="btn-next">変更</span></a><br><span><?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']['priority_message'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                    </td>
                </tr><!--競合アラート--><?php if (((is_array($_tmp=$this->_tpl_vars['plugin']['conflict_message'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?><tr><td class="attention_fookpoint" colspan="3">
                ...
                </tr><?php endif; ?><?php endfor; endif; ?></table><?php else: ?><span>登録されているプラグインはありません。</span>
        <?php endif; ?>
    </div>
</form>