...
if (is_file(MODULE_REALDIR . 'mdl_pg_mulpay/inc/include.php')) {
    ...
    require_once(MDL_PG_MULPAY_CLASSEX_PATH . 'plugin_extends/LC_Pg2Click_Ex.php');
}
 ...
 * @version $Id: $
 */
class Pg2Click extends SC_Plugin_Base {
    ...
    function install($arrPlugin) {
        // 必要なファイルをコピーします.
        @copy(MDL_PG_MULPAY_PATH . "media/logo.png", PLUGIN_HTML_REALDIR . "Pg2Click/logo.png");
        @copy(PLUGIN_UPLOAD_REALDIR . "Pg2Click/btn_2click.png", PLUGIN_HTML_REALDIR . "Pg2Click/btn_2click.png");
        @copy(PLUGIN_UPLOAD_REALDIR . "Pg2Click/btn_2click_on.png", PLUGIN_HTML_REALDIR . "Pg2Click/btn_2click_on.png");
    }
...
//        $arrData = $this->loadData();
//        if(SC_Utils_Ex::isBlank($arrData['2click_enable'])) return;
        $class_name = get_class($objPage);
        $obj = new LC_Pg2Click_Ex();
...
//        if(SC_Utils_Ex::isBlank($arrData['2click_enable'])) return;
    ...
    function loadData() {
        $arrRet = array();
        $arrData = SC_Plugin_Util_Ex::getPluginByPluginCode("Pg2Click");
