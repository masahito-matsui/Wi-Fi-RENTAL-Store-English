    ...
    <div id="undercolumn_entry">
        ...
        <div id="complete_area">
            ...
            <div class="shop_information">
                ...
                <p>TEL: <!--{$arrSiteInfo.tel01}-->-<!--{$arrSiteInfo.tel02}-->-<!--{$arrSiteInfo.tel03}--> <!--{if $arrSiteInfo.business_hour != ""}-->（<!--{$arrSiteInfo.business_hour}-->）<!--{/if}--><br />
                    Emall: <a href="mailto:<!--{$arrSiteInfo.email02|escape:'hex'}-->"><!--{$arrSiteInfo.email02|escape:'hexentity'}--></a></p>
            </div>
