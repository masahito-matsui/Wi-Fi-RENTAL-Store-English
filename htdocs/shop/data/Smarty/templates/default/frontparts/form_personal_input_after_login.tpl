...
<!--{strip}-->
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->; ime-mode: disabled;" class="box120" />&nbsp;
        </td>
    </tr>
    <!--<tr>
...
<!--			<option value="0" selected="selected">選択してください</option>-->
			...
			<input type="hidden" name="<!--{$key3}-->" value="7777" maxlength="<!--{$arrForm[$key3].length}-->" style="<!--{$arrErr[$key3]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />
        </td>
    </tr>
