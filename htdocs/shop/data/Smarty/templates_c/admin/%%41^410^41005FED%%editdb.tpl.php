<?php /* Smarty version 2.6.27, created on 2022-04-10 11:37:53
         compiled from system/editdb.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'system/editdb.tpl', 4, false),)), $this); ?>


<form name="index_form" id="index_form" method="post" action="?">
    <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value="confirm"><div class="btn">
        <a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('index_form', 'confirm', '', '');"><span class="btn-next">変更する</span></a>
    </div>
    <table class="list"><col width="5%"><col width="5%"><col width="25%"><col width="25%"><col width="40%"><tr><th colspan="2">インデックス</th>
...
"><input type="radio" name="indexflag_new[<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
            ...
            </tr><?php endfor; endif; ?></table><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('index_form', 'confirm', '', ''); return false;"><span class="btn-next">変更する</span></a>
</form>