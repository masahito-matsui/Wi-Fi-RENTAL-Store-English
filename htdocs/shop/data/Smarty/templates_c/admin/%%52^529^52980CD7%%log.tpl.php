<?php /* Smarty version 2.6.27, created on 2021-10-04 18:42:10
         compiled from ownersstore/log.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'ownersstore/log.tpl', 4, false),array('modifier', 'h', 'ownersstore/log.tpl', 11, false),array('modifier', 'sfDispDBDate', 'ownersstore/log.tpl', 13, false),)), $this); ?>


<form name="form1" id="form1" method="post" action="?">
    <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value="register"><div id="ownersstore" class="contents-main">

        <table class="list center"><tr><th>モジュール名</th>
                <th>ステータス</th>
                <th>日時</th>
                <th>詳細</th>
                
            </tr><?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrInstallLogs'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['log_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['log_loop']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['log']):
        $this->_foreach['log_loop']['iteration']++;
?><tr><td class="left"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['log']['module_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
