...
require_once PLUGIN_UPLOAD_REALDIR . "OrderSort/class/plg_OrderSort_LC_Page_Admin_Order_Mail.php";

class plg_OrderSort_LC_Page_Admin_Order_Mail_Ex extends plg_OrderSort_LC_Page_Admin_Order_Mail{
    /**
