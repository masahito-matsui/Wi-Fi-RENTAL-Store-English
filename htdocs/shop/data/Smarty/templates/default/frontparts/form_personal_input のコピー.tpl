...
<!--{strip}-->
    ...
    <tr>
        ...
        <td>
            ...
            <p class="attention mini gray">Please fill out by alphabet.<br>Symbols ( , . = ' ･ etc) can not be entered.</p>
        </td>
    </tr>
    <!--<tr>
    ...
    <!--{if $flgFields > 1}-->
        <tr>
            ...
            <td>
                ...
                <span class="attention mini gray">Please fill in twice to make sure</span>
            </td>
        </tr>
        <!--{if $emailMobile}-->
            <tr>
...
<!--			<option value="0" selected="selected">選択してください</option>-->
        ...
        <td>
         ...
         <span class="attention mini">Please key in present terminal number that begins with YM- EM- au- SB-...</span>   
        </td>
			<!--{/if}-->
