<?php /* Smarty version 2.6.27, created on 2022-08-28 15:00:27
         compiled from mail/template_input.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail/template_input.tpl', 4, false),array('modifier', 'h', 'mail/template_input.tpl', 4, false),array('function', 'sfSetErrorStyle', 'mail/template_input.tpl', 7, false),array('function', 'html_radios', 'mail/template_input.tpl', 7, false),)), $this); ?>
...
"><div id="mail" class="contents-main">
        <table class="form"><tr><th>メール形式<span class="attention"> *</span></th>
                <td>
 ...
 <?php endif; ?>><?php echo smarty_function_html_radios(array('name' => 'mail_method','options' => ((is_array($_tmp=$this->_tpl_vars['arrMagazineType'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'separator' => "&nbsp;",'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['mail_method'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
            ...
            </tr><tr><th>Subject<span class="attention"> *</span></th>
                <td>
...
"><?php if (((is_array($_tmp=$this->_tpl_vars['arrErr']['subject'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><br><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['subject'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
            ...
            </tr><tr><th>本文<span class="attention"> *</span><br>（名前差し込み時は {name} といれてください）</th>
                <td>
...
</textarea><?php if (((is_array($_tmp=$this->_tpl_vars['arrErr']['body'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><br><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['body'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span><?php endif; ?>
                    <div>
                        ...
                        <span>今までに入力したのは<input type="text" name="cnt_footer" size="4" class="box4" readonly style="text-align:right">文字です。</span>
                    </div>
                </td>
            </tr></table><div class="btn-area">
            <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('form1', '<?php echo ((is_array($_tmp=$this->_tpl_vars['mode'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
