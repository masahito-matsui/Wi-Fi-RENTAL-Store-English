...
<section>
    ...
    <div class="information">
        <p>Please note that all fields followed by mark of <span class="attention">※</span> must be filled in<br />
    ...
    <form name="form1" id="form1" method="post" action="<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php">
        ...
        <div class="btn_area">
            <input class="btn" type="submit" value="Registration" name="register" id="register" />
        </div>
    </form>
</section>
