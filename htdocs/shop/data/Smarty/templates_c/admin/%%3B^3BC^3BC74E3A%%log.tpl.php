<?php /* Smarty version 2.6.27, created on 2021-10-04 18:34:17
         compiled from system/log.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'system/log.tpl', 7, false),array('modifier', 'h', 'system/log.tpl', 16, false),array('modifier', 'sfGetErrorColor', 'system/log.tpl', 16, false),array('modifier', 'nl2br', 'system/log.tpl', 26, false),array('function', 'html_options', 'system/log.tpl', 16, false),)), $this); ?>
...
</style><?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrErr'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) >= 1): ?><div class="attention">
...
</select><?php $this->assign('key', 'line_max'); ?>
...
<table class="list log"><tr><th>日時</th>
        <th>パス</th>
        <th>内容</th>
    </tr><?php $_from = ((is_array($_tmp=$this->_tpl_vars['tpl_ec_log'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['line']):
?><tr><td class="date"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['line']['date'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
        ...
        </tr><?php endforeach; endif; unset($_from); ?></table>