...
<a href="http://www.gmo-pg.com/?argument=2qpV46CP&dmai=a5177c923cb929" target="_blank" onmouseover="chgImg('<!--{$smarty.const.MDL_PG_MULPAY_MEDIAFILE_URL}-->about_pg_on.jpg','pg');" onmouseout="chgImg('<!--{$smarty.const.MDL_PG_MULPAY_MEDIAFILE_URL}-->about_pg.jpg','pg')">
...
<a href="https://service.gmo-pg.com/cyllene/entry/trialStart.htm?argument=2qpV46CP&dmai=a5177c98d5464d" target="_blank" onmouseover="chgImg('<!--{$smarty.const.MDL_PG_MULPAY_MEDIAFILE_URL}-->test_on.jpg','test');" onmouseout="chgImg('<!--{$smarty.const.MDL_PG_MULPAY_MEDIAFILE_URL}-->test.jpg','test');">
