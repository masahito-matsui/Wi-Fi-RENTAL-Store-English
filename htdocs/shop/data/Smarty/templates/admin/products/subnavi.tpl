...
<li<!--{if $tpl_subno == 'upload_csv_esim'}--> class="on"<!--{/if}--> id="navi-products-upload-csv-esim"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/upload_csv_esim.php"><span>eSIM登録CSV</span></a></li>
