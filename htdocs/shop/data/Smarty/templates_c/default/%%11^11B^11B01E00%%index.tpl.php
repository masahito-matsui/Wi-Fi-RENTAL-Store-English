<?php /* Smarty version 2.6.27, created on 2021-10-27 13:18:05
         compiled from /data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/contact/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/contact/index.tpl', 32, false),array('modifier', 'default', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/contact/index.tpl', 40, false),array('modifier', 'h', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/contact/index.tpl', 40, false),array('modifier', 'sfGetErrorColor', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/contact/index.tpl', 40, false),array('function', 'html_options', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/contact/index.tpl', 75, false),)), $this); ?>
...
" />
            ...
            <table summary="お問い合わせ">
                <tr>
                    <th>Your name<span class="attention">※</span></th>
                    <td>
...
; ime-mode: disabled;" /><br />
                        <p class="mini"><span class="attention">Please fill in twice to make sure.</span></p>
                    </td>
                </tr>
                <tr>
                    <th>Message<span class="attention">※</span><br />
                    <span class="mini" style="display:none">（全角<?php echo ((is_array($_tmp=@MLTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
字以下）</span></th>
                    <td>
                        ...
                        <textarea name="contents" class="area-100" cols="60" rows="20" style="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr']['contents']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['contents']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
            ...
            <div class="btn_area">
                <ul>
                    <li class="single">
                        <input type="image" class="btn_hover" src="/shop/img/btn/confirm.png" width="100%" alt="確認ページへ" name="confirm" />
                    </li>
                </ul>
            </div>
