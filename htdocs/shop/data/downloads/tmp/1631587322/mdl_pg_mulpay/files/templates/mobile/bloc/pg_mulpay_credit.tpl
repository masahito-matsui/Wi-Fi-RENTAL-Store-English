...
<!--{strip}-->
        ...
        <!--{if !$tpl_is_loading}-->
            ...
            <hr>
                    ...
                    <!--{/if}-->
                    <input type="text" name="<!--{$key1}-->" value="" maxlength="<!--{$arrForm[$key1].length}-->" istyle="3" size="16" />
                    <br>
                    <br>
                    ...
                    <!--{/if}-->
                        ...
                        名:<input type="text" name="<!--{$key1}-->" value="" maxlength="<!--{$arrForm[$key1].length}-->" istyle="3" size="20"  />
                        <br>
                        姓:<input type="text" name="<!--{$key2}-->" value="" maxlength="<!--{$arrForm[$key2].length}-->" istyle="3" size="20"  />
                        <br>
                ...
                <!--{if $arrPaymentInfo.use_securitycd == '1'}-->
                    ...
                    <!--{/if}-->
                        <input type="text" name="<!--{$key}-->" value="" maxlength="<!--{$arrForm[$key].length}-->" istyle="3" size="4" />
                        <br>
