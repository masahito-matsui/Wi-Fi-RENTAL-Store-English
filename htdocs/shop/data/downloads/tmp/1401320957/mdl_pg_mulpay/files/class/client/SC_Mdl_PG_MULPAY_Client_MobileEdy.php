...
/**
 * 決済モジュール 決済処理: MobileEdy
 */
class SC_Mdl_PG_MULPAY_Client_MobileEdy extends SC_Mdl_PG_MULPAY_Client_Base_Ex {
    ...
    function doPaymentRequest($arrOrder, $arrParam, $arrPaymentInfo) {
        ...
        $server_url = $arrMdlSetting['server_url'] . 'EntryTranEdy.idPass';
        ...
        $server_url = $arrMdlSetting['server_url'] . 'ExecTranEdy.idPass';
        $arrSendKey = array(
            'AccessID',
            'AccessPass',
            'OrderID',
