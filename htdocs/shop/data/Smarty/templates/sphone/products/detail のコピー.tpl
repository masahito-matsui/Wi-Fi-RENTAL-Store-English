                ...
                <div class="product_detail">
                    ...
                    <!--{if $arrProduct.price01_max_inctax > 0}-->
                        <p class="normal_price">
                            ...
                            <span id="price01_default">
                                ...
                                <!--{/if}--></span>
                            <span id="price01_dynamic"></span>yen
                        </p>
                    <!--{/if}-->
                    ...
                    <p class="sale_price">
                        ...
                        <span class="price"><span id="price02_default">
                            ...
                            <!--{/if}-->
                        </span><span id="price02_dynamic"></span>yen</span>
                    </p>
...
<!--                            <a rel="external" href="javascript:void(document.form1.submit());" class="btn cartbtn_default">カートに入れる</a>-->
                            <a href="javascript:void(0)" onclick="javascript:checkWarranty();return false;" class="btn cartbtn_default">Add to cart</a>
                        </div>
...
Please order Y!mobile or SoftBank if you are in hurry.</div>
  ...
  <!--{if $arrRelativeCat.0.0.category_id == 11}-->
    ...
    <p class="attention_text">Basically, the router is available with no limitation. But the case a large amount of data communication is used such as an usage of 5 or more GB per a day, it may implement a communication restliction.</p>
