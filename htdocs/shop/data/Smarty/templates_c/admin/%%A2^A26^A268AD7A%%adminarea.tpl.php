<?php /* Smarty version 2.6.27, created on 2022-04-10 11:37:17
         compiled from system/adminarea.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'system/adminarea.tpl', 12, false),array('modifier', 'h', 'system/adminarea.tpl', 17, false),array('modifier', 'sfGetErrorColor', 'system/adminarea.tpl', 37, false),)), $this); ?>
...
"><div id="system" class="contents-main">
        ...
        <h2>管理機能設定</h2>
        <table id="basis-index-admin"><tr><th>ディレクトリ名</th>
                <td>
...
" <?php if (((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?> <?php if (! ((is_array($_tmp=$this->_tpl_vars['tpl_enable_ssl'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?> disabled <?php endif; ?>><label for="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
">SSLを強制する。</label>
                </td>
            </tr><tr><th>IP制限</th>
                <td>
...
</textarea><span class="attention"> (上限<?php echo ((is_array($_tmp=@LTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span><br><span>※管理機能へのアクセスを特定のIPアドレスからの接続のみに制限します。<br>
                    アクセスを許可するIPアドレスを1行づつ入力してください。何も入力しない場合は全てを許可します。</span><br></td>
            </tr></table><div class="btn-area">
            <ul><li><a class="btn-action" href="#"><span class="btn-next">この内容で登録する</span></a></li>
            </ul></div>
    </div>
