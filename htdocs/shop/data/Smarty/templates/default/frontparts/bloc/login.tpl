                ...
                <div class="block_body">
                    <!--{if $tpl_login}-->
                        <p>Welcome / Mr./Ms. <br />
                            ...
                            <!--{if $smarty.const.USE_POINT !== false}-->
                                 your current points is ：<span class="point"> <!--{$tpl_user_point|number_format|default:0}--> pt</span>
                            <!--{/if}-->
                        </p>
                    ...
                    <!--{else}-->
                        ...
                        <dl class="formlist">
                            ...
                            <dd class="mini">
                                <a href="<!--{$smarty.const.HTTPS_URL}-->forgot/<!--{$smarty.const.DIR_INDEX_PATH}-->" onclick="eccube.openWindow('<!--{$smarty.const.HTTPS_URL}-->forgot/<!--{$smarty.const.DIR_INDEX_PATH}-->','forget','600','400',{scrollbars:'no',resizable:'no'}); return false;" target="_blank">The person who has forgotten password.</a>
                            </dd>
                        </dl>
                        <p class="btn">
