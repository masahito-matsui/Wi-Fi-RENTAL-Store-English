...
require_once PLG_CC_GAECUA_CLASS_PATH . 'pages/plg_GAECommerceUA_LC_Page_Config.php';
 ...
 * @version $Id: $
 */
class plg_GAECommerceUA_LC_Page_Config_Ex extends plg_GAECommerceUA_LC_Page_Config {
}
