<?php /* Smarty version 2.6.27, created on 2021-11-27 12:44:16
         compiled from contents/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'contents/index.tpl', 5, false),array('modifier', 'default', 'contents/index.tpl', 5, false),array('modifier', 'h', 'contents/index.tpl', 5, false),array('modifier', 'date_format', 'contents/index.tpl', 50, false),array('modifier', 'nl2br', 'contents/index.tpl', 52, false),array('function', 'html_options', 'contents/index.tpl', 8, false),array('function', 'math', 'contents/index.tpl', 49, false),)), $this); ?>
...
" <?php endif; ?>><option value="" selected>--</option><?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrDay'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['day']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
            ...
            </tr><tr><th>タイトル<span class="attention"> *</span></th>
                <td>
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['news_comment']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</textarea><br><span class="attention"> (上限3000文字)</span>
                </td>
            </tr></table><div class="btn-area">
            <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('form1', 'edit', '', ''); return false;"><span class="btn-next">この内容で登録する</span></a></li>
            </ul></div>
    </form>
    ...
    <form name="move" id="move" method="post" action="?">
        <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value="moveRankSet"><input type="hidden" name="news_id" value=""><input type="hidden" name="moveposition" value=""><input type="hidden" name="rank" value=""><table class="list"><col width="5%"><col width="15%"><col width="45%"><col width="5%"><col width="5%"><col width="25%"><tr><th>順位</th>
                <th>日付</th>
                <th>タイトル</th>
                <th class="edit">編集</th>
...
<?php endif; ?>;" class="center"><?php $this->assign('db_rank', ($this->_tpl_vars['arrNews'][$this->_sections['data']['index']]['rank'])); ?><td><?php echo smarty_function_math(array('equation' => ($this->_tpl_vars['line_max'])." - ".($this->_tpl_vars['db_rank'])." + 1"), $this);?>
</td>
...
'); return false;">移動</a><br><?php endif; ?><?php if (((is_array($_tmp=$this->_sections['data']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != 1): ?><a href="?" onclick="eccube.fnFormModeSubmit('move','up','news_id','<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrNews'][$this->_sections['data']['index']]['news_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
'); return false;">上へ</a>
                    <?php endif; ?>
...
'); return false;">下へ</a>
            ...
            </tr><?php endfor; else: ?><tr class="center"><td colspan="6">現在データはありません。</td>
