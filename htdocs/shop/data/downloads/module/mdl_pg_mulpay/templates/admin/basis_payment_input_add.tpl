...
<!--{if $plg_pg_mulpay_payid == MDL_PG_MULPAY_PAYID_CREDIT || $plg_pg_mulpay_payid == MDL_PG_MULPAY_PAYID_REGIST_CREDIT || $plg_pg_mulpay_payid == MDL_PG_MULPAY_PAYID_CREDIT_CHECK || $plg_pg_mulpay_payid == MDL_PG_MULPAY_PAYID_CREDIT_SAUTH || $plg_pg_mulpay_payid == MDL_PG_MULPAY_PAYID_TOKEN}-->
...
。）
    ...
    <!--{/if}-->
		...
		<input id="<!--{$key}-->"
		       ...
		       maxlength="<!--{$arrForm[$key].length|escape}-->">分
		<span style="font-size:80%"><br />
		...
		<input id="<!--{$key}-->"
		       ...
		       class="box6"
		       value="<!--{$arrForm[$key].value|h}-->"
		       maxlength="<!--{$arrForm[$key].length|escape}-->">回
		<span style="font-size:80%"><br />
		  ※入力回数制限を利用しない場合、入力は不要です。<br />
