<?php
/** フロント表示関連 */
define('SAMPLE_ADDRESS1', " (e.g., KS building 2F 1-5)");
/** フロント表示関連 */
define('SAMPLE_ADDRESS2', " (e.g., Kandasuda-cho Chiyoda-ku Tokyo)");
/** ユーザファイル保存先 */
...
/** 通常画像横 */
define('NORMAL_IMAGE_WIDTH', 351);
/** 通常画像縦 */
define('NORMAL_IMAGE_HEIGHT', 351);
/** 通常サブ画像横 */
...
/** 短い項目の文字数 (名前など) */
define('STEXT_LEN', 200);
define('SMTEXT_LEN', 200);
/** 長い項目の文字数 (住所など) */
define('MTEXT_LEN', 400);
/** 長中文の文字数 (問い合わせなど) */
define('MLTEXT_LEN', 99999);
/** 長文の文字数 */
define('LTEXT_LEN', 99999);
/** 超長文の文字数 (メルマガなど) */
