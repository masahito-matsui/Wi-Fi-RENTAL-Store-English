...
require_once PLUGIN_UPLOAD_REALDIR . "ExpressLink/class/plg_ExpressLink_LC_Page_Admin_Order.php";

class plg_ExpressLink_LC_Page_Admin_Order_Ex extends plg_ExpressLink_LC_Page_Admin_Order
{
