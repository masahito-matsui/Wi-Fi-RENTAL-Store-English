<?php /* Smarty version 2.6.27, created on 2024-11-05 17:39:59
         compiled from design/css.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'design/css.tpl', 4, false),array('modifier', 'h', 'design/css.tpl', 4, false),array('modifier', 'sfGetErrorColor', 'design/css.tpl', 16, false),)), $this); ?>


<form name="form_css" id="form_css" method="post" action="?">
    <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value=""><input type="hidden" name="area_row" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['area_row'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
"><div id="design" class="contents-main">
        ...
        <!--▼CSS設定ここから-->
        <table class="form"><tr><th>CSSファイル名</th>
                <td>
...
</textarea><input type="hidden" name="area_row" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['area_row'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><div class="btn">
            ...
            <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('form_css','confirm','',''); return false;"><span class="btn-next">この内容で登録する</span></a></li>
            </ul></div>
        <!--▲CSS設定　ここまで-->
...
"><span>CSSを新規入力</span></a>
        ...
        <table class="list" id="design-css-list"><tr><th class="name">ファイル名</th>
                <th class="menu edit">編集</th>
                <th class="action delete">削除</th>
            </tr><?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrCSSList'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?><?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrCSSList'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
'); return false;">削除</a>
            ...
            </tr><?php endforeach; endif; unset($_from); ?><?php else: ?><tr><td colspan="3">CSSファイルが存在しません。</td>
            </tr><?php endif; ?></table><!--▲CSSファイル一覧　ここまで--></div>
</form>