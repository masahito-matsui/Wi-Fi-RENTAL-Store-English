<?php /* Smarty version 2.6.27, created on 2022-01-14 15:35:57
         compiled from design/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'design/header.tpl', 5, false),array('modifier', 'h', 'design/header.tpl', 14, false),)), $this); ?>
...
"><input type="hidden" name="mode" value=""><input type="hidden" name="division" value="header"><input type="hidden" name="header_row" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['header_row'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['header_data'])) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
        ...
        <div class="btn-area">
                <ul><li><a class="btn-action" href="javascript:;" name="subm" onclick="eccube.fnFormModeSubmit('form_header','regist','',''); return false;"><span class="btn-next">登録する</span></a></li>
                </ul></div>
    ...
    <form name="form_footer" id="form_footer" method="post" action="?">
        <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value=""><input type="hidden" name="division" value="footer"><input type="hidden" name="footer_row" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['footer_row'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="device_type_id" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['device_type_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['footer_data'])) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
        ...
        <div class="btn-area">
                <ul><li><a class="btn-action" href="javascript:;" name="subm" onclick="eccube.fnFormModeSubmit('form_footer','regist','',''); return false;"><span class="btn-next">登録する</span></a></li>
                </ul></div>
