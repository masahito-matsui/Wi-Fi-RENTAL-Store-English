<?php /* Smarty version 2.6.27, created on 2022-04-07 16:34:12
         compiled from order/pdf_input_ex.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'order/pdf_input_ex.tpl', 37, false),array('modifier', 'h', 'order/pdf_input_ex.tpl', 37, false),array('modifier', 'join', 'order/pdf_input_ex.tpl', 40, false),array('modifier', 'date_format', 'order/pdf_input_ex.tpl', 74, false),array('function', 'html_options', 'order/pdf_input_ex.tpl', 43, false),)), $this); ?>
...
"><?php endforeach; endif; unset($_from); ?><h2><!--コンテンツタイトル-->帳票の作成</h2>
    ...
    <table class="form"><col width="20%"><col width="80%"><tr><th>注文番号</th>
            ...
            <td><?php if (((is_array($_tmp=$this->_tpl_vars['arrErr']['download'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['download'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
                ...
                <select name="type" class="type"><?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrType'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['type'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
</select></td>
        ...
        </tr><tr class="statementOfDelivery"><th>帳票タイトル</th>
...
"><br><span style="font-size: 80%;">※未入力時はデフォルトのタイトルが表示されます。</span><br></td>
        </tr><tr class="statementOfDelivery"><th>帳票メッセージ</th>
...
"><br><span style="font-size: 80%;">※未入力時はデフォルトのメッセージが表示されます。</span><br></td>
        </tr><tr class="statementOfDelivery"><th>備考</th>
...
"><br><span style="font-size: 80%;">※未入力時は表示されません。</span><br></td>
        </tr><?php if (((is_array($_tmp=@USE_POINT)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) !== false): ?><tr class="statementOfDelivery"><th>ポイント表記</th>
                <td>
            ...
            </tr><?php else: ?><input type="hidden" name="disp_point" value="0"><?php endif; ?><tr class="ReceiptDocumentDelivery"><th>宛名</th>
            <td>
			<?php if (((is_array($_tmp=$this->_tpl_vars['isOrders'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
				<?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrPReceipts'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['v']):
?>
					（注文番号：<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['v']['order_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
）<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['v']['update_date'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y&#x5E74;%-m&#x6708;%-e&#x65E5;') : smarty_modifier_date_format($_tmp, '%Y&#x5E74;%-m&#x6708;%-e&#x65E5;')); ?>
:<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['v']['address'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
<br>
					　　<span style="color:red;">注意！この注文番号の領収書は以前に一度以上の出力がなされています。</span><br><?php endforeach; endif; unset($_from); ?><br><b>領収書の宛名は複数時は注文時の名称で登録/出力されます</b><br><?php else: ?><?php if (is_array ( ((is_array($_tmp=$this->_tpl_vars['arrPReceipt'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) )): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['arrPReceipt']['company'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['arrPReceipt']['address'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<input type="hidden" name="rd_cp" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrPReceipt']['company'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="rd_ad" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrPReceipt']['address'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><?php else: ?><div><label>社名<input type="text" name="r_cp" size="40" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['r_cp'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" maxlength="<?php echo ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"></label></div>
					<div><label>名前<input type="text" name="r_ad" size="40" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['r_ad'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" maxlength="<?php echo ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"></label></div>
				<?php endif; ?>
			<?php endif; ?>
			</td>
        </tr><tr class="ReceiptDocumentDelivery"><th>但し書き</th>
            <td>
...
?>
					（注文番号：<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['v']['order_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
）<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['v']['update_date'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y&#x5E74;%-m&#x6708;%-e&#x65E5;') : smarty_modifier_date_format($_tmp, '%Y&#x5E74;%-m&#x6708;%-e&#x65E5;')); ?>
:<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['v']['proviso'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
<br>
					　　<span style="color:red;">注意！この注文番号の領収書は以前に一度以上の出力がなされています。</span><br><?php endforeach; endif; unset($_from); ?><br><b>新たに作成する領収書の但し書き</b><br><input type="text" name="r_but" size="40" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['r_but'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" maxlength="<?php echo ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><?php else: ?><?php if (is_array ( ((is_array($_tmp=$this->_tpl_vars['arrPReceipt'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) )): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['arrPReceipt']['proviso'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<input type="hidden" name="rd_but" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrPReceipt']['proviso'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><?php else: ?><input type="text" name="r_but" size="40" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['r_but'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" maxlength="<?php echo ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><?php endif; ?><?php endif; ?></td>
        </tr></table><?php if (is_array ( ((is_array($_tmp=$this->_tpl_vars['arrPReceipt'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) )): ?><div class="ReceiptDocumentDelivery" style="color:red;">
		注意！<br>この注文番号の領収書は以前に一度以上の出力がなされています。<br>(<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrPReceipt']['update_date'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y&#x5E74;%-m&#x6708;%-e&#x65E5;') : smarty_modifier_date_format($_tmp, '%Y&#x5E74;%-m&#x6708;%-e&#x65E5;')); ?>
:<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrPReceipt']['proviso'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
)
	</div>
	<?php endif; ?>
    <div class="btn-area">
