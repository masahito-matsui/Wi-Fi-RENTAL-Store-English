 ...
 * @version $Id: LC_Page_Admin_Order.php 23129 2013-08-26 14:43:24Z pineray $
 */
class LC_Page_Admin_Order extends LC_Page_Admin_Ex
{
    ...
    public function lfInitParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('備考', 'search_message', STEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
        $objFormParam->addParam('メモ', 'search_note', STEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
    }
    ...
    public function buildQuery($key, &$where, &$arrValues, &$objFormParam)
    {
        ...
        switch ($key) {
            ...
            case 'search_order_name':
                $where .= ' AND (order_name01 LIKE ? OR order_name02 LIKE ?)';
//                $where .= ' AND ' . $dbFactory->concatColumn(array('order_name01', 'order_name02')) . ' LIKE ?';
            ...
            case 'search_order_kana':
                $where .= ' AND (order_kana01 LIKE ? OR order_kana02 LIKE ?)';
