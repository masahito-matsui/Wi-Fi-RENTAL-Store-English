<?php /* Smarty version 2.6.27, created on 2025-12-12 18:54:00
         compiled from /data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 59, false),array('modifier', 'h', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 59, false),array('modifier', 'nl2br_html', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 374, false),array('modifier', 'sfPrePoint', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 1272, false),array('modifier', 'number_format', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 1272, false),array('modifier', 'strlen', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 1588, false),array('modifier', 'sfGetErrorColor', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 1643, false),array('modifier', 'default', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 1672, false),array('modifier', 'sfDispDBDate', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 2654, false),array('modifier', 'nl2br', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 2655, false),array('modifier', 'u', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 2670, false),array('modifier', 'sfNoImageMainList', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 2671, false),array('function', 'html_options', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/default/products/detail.tpl', 1644, false),)), $this); ?>
...
$(function(){
   $('.enter_form').on('keydown keyup keypress change focus blur', function(){
    ...
    <!--★商品名★-->
<h2 class="product-name"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrProduct']['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</h2>
<div id="undercolumn">
<?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrRelativeCat'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?>
 <?php if (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 30): ?>
...
<section class="product_detail_wrap clearfix">
 ...
 <?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrRelativeCat'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?>
  <?php if (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 22): ?>
  <!---FS030W 20GB 通常--->
             <div class="content">
                <ul class="main">
  ...
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 25): ?>
  <!---601HW 50GB 通常--->
             <div class="content">
                <ul class="main">
  ...
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 26): ?>
  <!---809SH 通常--->
             <div class="content">
                <ul class="main">
  ...
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 33): ?>
  <!---FS050W 無制限 通常--->
             <div class="content">
                <ul class="main">
  ...
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['0']['0']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 38): ?>
  <!---物理SIM 通常--->
             <div class="content">
                <ul class="main">
  ...
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['0']['0']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 35): ?>
  <!---eSIM 通常--->
             <div class="content">
                <ul class="main">
  ...
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 24): ?>
  <!---FS030W 20GB延長--->
             <div class="content">
                <ul class="main">
    ...
    <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 27): ?>
  <!---601HW 50GB延長--->
             <div class="content">
                <ul class="main">
    ...
    <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 28): ?>
  <!---809SH延長--->
             <div class="content">
                <ul class="main">
    ...
    <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 34): ?>
  <!---FS050W 無制限 延長--->
             <div class="content">
                <ul class="main">
  ...
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 30): ?>
  <!---HWD11延長--->
             <div class="content">
                <ul class="main">
  ...
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 29): ?>
  <!---303ZT延長--->
             <div class="content">
                <ul class="main">
...
～<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrProduct']['product_code_max'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
 ...
 <?php if (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['0']['0']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 12): ?>
<style>
.ex_limit30 {
...
<div class="main_comment" style="display:none;"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrProduct']['main_comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('nl2br_html', true, $_tmp) : smarty_modifier_nl2br_html($_tmp)); ?>
</div>
   </div>
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['1']['1']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 25): ?>
   <!--★商品説明 601HW 50GB 通常★-->
...
<?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrRelativeCat'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?>
<?php if (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['0']['0']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 38): ?>
<!--★注意事項エリア　物理SIM-->
...
<?php endif; ?>
                ...
                <dl class="sale_price">
                    ...
                    <dt style="display:none;"><?php echo ((is_array($_tmp=@SALE_PRICE_TITLE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
(税込)：</dt>
                    <dt style="display:none;"><?php echo ((is_array($_tmp=@SALE_PRICE_TITLE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
(税込)：</dt>
  <?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrRelativeCat'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?>
  <?php if (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['0']['0']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 13): ?>
...
：</li>
                                    <li>
                                        <select id="classcategory_id1" name="classcategory_id1" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr']['classcategory_id1'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
">
...
：</li>
                                    <li>
                                        <select id="classcategory_id2" name="classcategory_id2" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr']['classcategory_id2'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
">
                                        </select>
                                ...
                                <div id="cartbtn_default">
                                    ...
                                    <a href="javascript:void(document.form1.submit())">
                                     <p class="btn_add_to_cart">Add to cart</p>
                                        <img style="display: none;" class="hover_change_image" src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
$(function(){
  ...
  <?php if (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['0']['0']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == ((is_array($_tmp=@RENTAL_PRODUCT_CATEGORY)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
  //console.log('rental');
  rental_flg = 1;
  $('.extension_option').addClass('no_disp');
  //延長レンタル時のみの挙動を追加するなら以下
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['0']['0']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == ((is_array($_tmp=@EXTENSION_PRODUCT_CATEGORY)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
  ...
  //物理SIMのみの挙動を追加するなら以下
  <?php elseif (((is_array($_tmp=$this->_tpl_vars['arrRelativeCat']['0']['0']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == ((is_array($_tmp=@B_SIM_CATEGORY)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
  bsim_flg = 1;
  ...
  <?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrRelativeCat'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key']):
?>
    <?php if (((is_array($_tmp=$this->_tpl_vars['key']['0']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == NO_BAT_CATEGORY): ?>
    nobat_flg = 1;
    <?php endif; ?>
  <?php endforeach; endif; unset($_from); ?>
