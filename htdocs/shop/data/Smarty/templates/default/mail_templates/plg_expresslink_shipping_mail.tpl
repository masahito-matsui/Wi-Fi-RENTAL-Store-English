...
<!--{else}-->
** Delivery Information<!--{if count($arrShipping) > 1}--><!--{$smarty.foreach.shipping.iteration}--><!--{/if}-->
...
Rental Plan/Model: <!--{$item.product_name|strip_tags}-->
<!--{assign var="kikaku1" value="-"|explode:$item.classcategory_name1}-->
<!--{$kikaku1[1]}-->
<!--{if $arrOrder.deliv_id == 5}-->
Extension rental period: <!--{$kikaku1[0]+1}--> days
Are you renting an additional battery?: <!--{$item.classcategory_name2}-->
<!--{elseif $arrOrder.deliv_id == 8}-->
<!--{elseif $arrOrder.deliv_id == 9}-->
<!--{else}-->
Rental period: <!--{$kikaku1[0]+1}--> days
Options: <!--{$item.classcategory_name2}-->
<!--{/if}-->
