<?php /* Smarty version 2.6.27, created on 2021-09-14 13:16:23
         compiled from basis/delivery_input.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/delivery_input.tpl', 4, false),array('modifier', 'h', 'basis/delivery_input.tpl', 4, false),array('modifier', 'sfGetErrorColor', 'basis/delivery_input.tpl', 11, false),array('function', 'html_radios', 'basis/delivery_input.tpl', 45, false),array('function', 'html_checkboxes', 'basis/delivery_input.tpl', 54, false),)), $this); ?>


<form name="form1" id="form1" method="post" action="">
    <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value="edit"><?php $this->assign('key', 'deliv_id'); ?><input type="hidden" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['keyname'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
"><div id="basis" class="contents-main">
        ...
        <table><tr><th>配送業者名<span class="attention"> *</span></th>
                <td colspan="3">
...
" size="60" class="box60"></td>
            </tr><tr><th>名称<span class="attention"> *</span></th>
                <td colspan="3">
...
?><?php $this->assign('type', ($this->_sections['cnt']['index']%2)); ?><?php $this->assign('keyno', ($this->_sections['cnt']['iteration'])); ?><?php $this->assign('key', "deliv_time".($this->_sections['cnt']['iteration'])); ?><?php $this->assign('key_next', "deliv_time".($this->_sections['cnt']['iteration']+1)); ?><?php if (((is_array($_tmp=$this->_tpl_vars['type'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 0): ?><?php if (((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != "" || ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key_next']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?><tr><td colspan="4"><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key_next']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
                ...
                </tr><?php endif; ?><tr><th>お届け時間<?php echo ((is_array($_tmp=$this->_tpl_vars['keyno'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</th>
...
"></td>
                </tr><?php endif; ?><?php endfor; endif; ?></table><h2>取扱商品種別</h2>
        <?php $this->assign('key', 'product_type_id'); ?>
        <table><tr><th>商品種別 <span class="attention">*</span></th>
                <td>
                    <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
...
">
            ...
            </tr></table><h2>取扱支払方法</h2>
        <?php $this->assign('key', 'payment_ids'); ?>
        <table><tr><th>支払方法 <span class="attention">*</span></th>
                <td>
                    <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                    <span style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
">
            ...
            </tr></table><?php if (((is_array($_tmp=@INPUT_DELIV_FEE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><h2>配送料登録</h2>
        ...
        <table><?php unset($this->_sections['cnt']);
$this->_sections['cnt']['name'] = 'cnt';
...
$this->_sections['cnt']['first']      = ($this->_sections['cnt']['iteration'] == 1);
$this->_sections['cnt']['last']       = ($this->_sections['cnt']['iteration'] == $this->_sections['cnt']['total']);
?><?php $this->assign('type', ($this->_sections['cnt']['index']%2)); ?><?php $this->assign('keyno', ($this->_sections['cnt']['iteration'])); ?><?php $this->assign('key', "fee".($this->_sections['cnt']['iteration'])); ?><?php $this->assign('key_next', "fee".($this->_sections['cnt']['iteration']+1)); ?><?php if (((is_array($_tmp=$this->_tpl_vars['type'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 0): ?><?php if (((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != "" || ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key_next']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?><tr><td colspan="4"><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key_next']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span></td>
                </tr><?php endif; ?><tr><th><?php echo ((is_array($_tmp=$this->_tpl_vars['arrPref'][$this->_tpl_vars['keyno']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" size="20" class="box20" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
"> 円</td>
                </tr><?php endif; ?><?php endfor; endif; ?></table><?php endif; ?><div class="btn-area">
            <ul><li><a class="btn-action" href="javascript:;" onclick="location.href='./delivery.php';"><span class="btn-prev">前のページに戻る</span></a></li>
