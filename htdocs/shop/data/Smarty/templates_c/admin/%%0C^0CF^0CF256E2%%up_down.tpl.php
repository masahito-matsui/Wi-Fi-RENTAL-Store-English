<?php /* Smarty version 2.6.27, created on 2022-12-15 12:00:59
         compiled from design/up_down.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'design/up_down.tpl', 17, false),array('modifier', 'h', 'design/up_down.tpl', 17, false),array('modifier', 'sfGetErrorColor', 'design/up_down.tpl', 32, false),)), $this); ?>
...
"><input type="hidden" name="mode" value=""><input type="hidden" name="device_type_id" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['device_type_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
"><div id="disign" class="contents-main">
        ...
        <table><?php $this->assign('key', 'template_code'); ?><tr><th>テンプレートコード</th>
                <td>
...
" class="box54"></td>
            </tr><?php $this->assign('key', 'template_name'); ?><tr><th>テンプレート名</th>
                <td>
                    <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                    <input type="text" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" maxlength="" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
" class="box54"></td>
            </tr><?php $this->assign('key', 'template_file'); ?><tr><th>テンプレートファイル<br><span class="attention"><span class="fs14n">※ファイル形式は.tar/.tar.gzのみ</span></span>
                </th>
                <td>
                    <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
...
" class="box54" size="64" <?php if (((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?> <?php endif; ?>></td>
