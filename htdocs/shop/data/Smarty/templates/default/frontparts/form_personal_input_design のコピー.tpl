...
<!--{strip}-->
    ...
    <tr>
        <th>Name<span class="attention">*</span><br>
             <span class="attention">In the case of delivery to hotels, the recipient name must accord with the reservation name at hotels.</span></th>
        <td>
            ...
            <p class="attention mini">Please fill out by alphabet</p>
        </td>
    </tr>
    <!--<tr>
    ...
    <!--{/if}-->
    <tr>
        <th>Post Code<!--{if !$smarty.const.FORM_COUNTRY_ENABLE}--><span class="attention">*</span><!--{/if}--></th>
        <td>
            <!--{if $arrErr[$key1] || $arrErr[$key2]}-->
                <div class="attention" style="background-color:#FFBCBD"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></div>
            <!--{/if}-->
            ...
            <div class="attention">When the postal code is not serchable, please enter "000-0000" and leave a message about it on remarks column.</div>
            </p>
            <!--<p class="zipimg">
    ...
    <tr>
        ...
        <tr>
        <th>Hotel name<br>
               <span class="attention">If your pickup location is a hotel, please enter the name of the hotel.</span></th>
        <td>
