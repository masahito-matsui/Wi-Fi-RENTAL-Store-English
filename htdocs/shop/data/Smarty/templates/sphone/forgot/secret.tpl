...
<section id="windowcolumn">
    ...
    <form action="?" method="post" name="form1">
        ...
        <div class="window_area clearfix">
            ...
            <p>* Your current password will be invalid after clicking Reset Password.<br>
<br>
* If you forget your answer for the following question, please contact us at: <a href="mailto:<!--{$arrSiteInfo.email02|escape:'hex'}-->"><!--{$arrSiteInfo.email02|escape:'hexentitiy'}--></a></p>

        </div>

        <p class="btn_area"><input type="submit" class="btn data-role-none" value="Reset Password" name="next" id="next" /></p>
    </form>
</section>
