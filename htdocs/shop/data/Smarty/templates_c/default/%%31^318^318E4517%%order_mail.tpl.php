<?php /* Smarty version 2.6.27, created on 2025-12-10 15:34:32
         compiled from mail_templates/order_mail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail_templates/order_mail.tpl', 22, false),array('modifier', 'explode', 'mail_templates/order_mail.tpl', 45, false),array('modifier', 'sfCalcIncTax', 'mail_templates/order_mail.tpl', 56, false),array('modifier', 'number_format', 'mail_templates/order_mail.tpl', 56, false),array('modifier', 'default', 'mail_templates/order_mail.tpl', 63, false),array('modifier', 'date_format', 'mail_templates/order_mail.tpl', 132, false),array('function', 'math', 'mail_templates/order_mail.tpl', 40, false),)), $this); ?>
...
$this->_sections['cnt']['last']       = ($this->_sections['cnt']['iteration'] == $this->_sections['cnt']['total']);
?>
<?php if (((is_array($_tmp=$this->_tpl_vars['arreSIM'][$this->_sections['cnt']['index']]['iccid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?>
────────────────
■ご利用開始方法
────────────────
□下記の「ご利用開始URL」から、手順に従ってご利用を開始してください。


  ご利用開始URL：<?php echo ((is_array($_tmp=$this->_tpl_vars['arreSIM'][$this->_sections['cnt']['index']]['url'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>

　eSIM番号：<?php echo ((is_array($_tmp=$this->_tpl_vars['arreSIM'][$this->_sections['cnt']['index']]['iccid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
