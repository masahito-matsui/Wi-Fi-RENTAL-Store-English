    ...
    public function action()
    {
        ...
        switch ($this->type) {
            case PRODUCT_NOT_FOUND:
                $this->tpl_error='Not found';
                SC_Response_Ex::sendHttpStatus(404);
                break;
            case PAGE_ERROR:
                $this->tpl_error='It is moved to incorrect page';
                break;
            case CART_EMPTY:
                $this->tpl_error='There is no item in your shopping cart.';
                break;
            case CART_ADD_ERROR:
                $this->tpl_error='Item can not be added to shopping cart during processing of purchase';
                break;
            ...
            case SITE_LOGIN_ERROR:
                $this->tpl_error='Error: Your email address or password is invalid.';
                break;
            case TEMP_LOGIN_ERROR:
                $this->tpl_error='It is wrong password or email address.<br />本登録がお済みでない場合は、仮登録メールに記載されている<br />URLより本登録を行ってください。';
                break;
            case CUSTOMER_ERROR:
                $this->tpl_error='It is incorrect access';
                break;
            case SOLD_OUT:
            ...
            case FREE_ERROR_MSG:
                ...
                break;
            default:
                $this->tpl_error='An error occurred';
                break;
        }
