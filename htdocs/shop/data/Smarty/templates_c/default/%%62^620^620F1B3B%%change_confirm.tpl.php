<?php /* Smarty version 2.6.27, created on 2023-10-12 02:00:00
         compiled from mypage/change_confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mypage/change_confirm.tpl', 4, false),array('modifier', 'h', 'mypage/change_confirm.tpl', 4, false),)), $this); ?>
...
"><input type="hidden" name="mode" value="complete"><input type="hidden" name="customer_id" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['customer_id']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
"><?php endif; ?><?php endforeach; endif; unset($_from); ?><table summary=" " class="delivname"><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?></table><div class="btn_area">
                <ul><li class="form_btn">
                    ...
                    <li class="form_btn">
                        <input type="image" class="btn_hover" src="/shop/img/btn/complete.png" width="100%" alt="送信" name="complete" id="complete"></li>
                </ul></div>
        </form>
    </div>
</div>