...
<dd>
    ...
    <!--{/if}-->
    <input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->; ime-mode: disabled;" class="boxHarf text data-role-none" placeholder="姓" />&nbsp;&nbsp;
...
<dt>Address&nbsp;<span class="attention">※</span><p><span class="attention mini gray">Please enter your home country address or your address in Japan.</span></p></dt>
<dd>
...
<!--{if $flgFields > 1}-->
    ...
    <dd>
        ...
        <input type="email" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->" class="boxLong text data-role-none" placeholder="Please fill in twice to make sure" />
    </dd>
    ...
    <!--{if $flgFields > 2}-->
        <dt>Preferred password&nbsp;<span class="attention">※</span></dt>
        <dd>
        ...
        <dt>A clue to password you have forgotten.&nbsp;<span class="attention">※</span></dt>
        <dd>
