<?php /* Smarty version 2.6.27, created on 2021-09-21 11:26:40
         compiled from products/product.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/product.tpl', 17, false),array('modifier', 'h', 'products/product.tpl', 51, false),array('modifier', 'sfGetErrorColor', 'products/product.tpl', 94, false),array('modifier', 'default', 'products/product.tpl', 134, false),array('modifier', 'function_exists', 'products/product.tpl', 196, false),array('modifier', 'sfNoImageMainList', 'products/product.tpl', 246, false),array('function', 'html_options', 'products/product.tpl', 70, false),array('function', 'html_radios', 'products/product.tpl', 74, false),array('function', 'html_checkboxes', 'products/product.tpl', 78, false),)), $this); ?>
...
;<?php endif; ?> height: 120px; min-width: 200px;" onchange="" size="10" multiple></select></td>
        ...
        </tr><tr><th>ダウンロード商品ファイル名<span class="attention"> *</span></th>
            <td>
...
文字)</span>
        ...
        </tr><tr><?php $this->assign('key', 'down_file'); ?><th>ダウンロード商品用<br>ファイルアップロード<span class="attention"> *</span></th>
            <td>
...
;<?php endif; ?>">円
        ...
        </tr><?php if (((is_array($_tmp=@OPTION_PRODUCT_TAX_RULE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?><tr><th>消費税率<span class="attention"> *</span></th>
            <td>
...
'); return false;">アップロード</a>
        ...
        </tr></table><?php if (((is_array($_tmp='sfViewAdminOpe')) ? $this->_run_mod_handler('function_exists', true, $_tmp) : function_exists($_tmp)) === TRUE): ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
