...
<h3>Pickup Method</h3>
<p class="text001 only_ext"><input type="radio" name="deliv_id" id="airport" value="3"><label for="airport">Post office inside airport　*540 yen is added to delivery fee<br><span class="s_text">　(Please enter " flight number " and " estimated arrival time " for flight in remarks column on the next page.  )</span</label></p>
