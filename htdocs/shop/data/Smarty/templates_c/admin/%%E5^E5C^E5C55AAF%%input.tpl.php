<?php /* Smarty version 2.6.27, created on 2022-01-31 11:07:56
         compiled from system/input.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'system/input.tpl', 11, false),array('modifier', 'h', 'system/input.tpl', 11, false),array('modifier', 'sfGetErrorColor', 'system/input.tpl', 16, false),array('modifier', 'sfGetChecked', 'system/input.tpl', 45, false),array('function', 'html_options', 'system/input.tpl', 38, false),)), $this); ?>
...
"><h2>メンバー登録/編集</h2>
    ...
    <table><col width="20%"><col width="80%"><tr><th>名前</th>
            <td>
...
～<?php echo ((is_array($_tmp=@ID_MAX_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字
                <br><input type="password" name="password02" size="20" class="box20" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrForm']['password02'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" onfocus="<?php echo ((is_array($_tmp=$this->_tpl_vars['tpl_onfocus'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" maxlength="<?php echo ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
</select><span class="attention">※必須入力</span>
            </td>
        </tr><tr><th>稼働/非稼働</th>
            <td>
