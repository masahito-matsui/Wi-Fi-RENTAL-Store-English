<?php /* Smarty version 2.6.27, created on 2025-06-12 15:46:20
         compiled from /data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/admin/products/subnavi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/data/en.wifi-rental-store.jp/htdocs/shop/data/Smarty/templates/admin/products/subnavi.tpl', 3, false),)), $this); ?>
...
<li <?php if (((is_array($_tmp=$this->_tpl_vars['tpl_subno'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'upload_csv_esim'): ?> class="on" <?php endif; ?> id="navi-products-upload-csv-esim"><a href="<?php echo ((is_array($_tmp=@ROOT_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php echo ((is_array($_tmp=@ADMIN_DIR)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
products/upload_csv_esim.php"><span>eSIM登録CSV</span></a></li>
