...
<form name="form1" id="form1" method="post" action="?">
    ...
    <input type="hidden" id="order_id" name="order_id" value="<!--{$arrForm.order_id.value|h}-->" />
        ...
        <table class="form">
            ...
            <tr style="display: none">
                ...
                <td>
                    ...
                    <input type="hidden" name="<!--{$arrForm[$key2].keyname}-->" value="<!--{$arrForm[$key2].value|h}-->" />
                    <input type="hidden" name="<!--{$arrForm[$key3].keyname}-->" value="<!--{$arrForm[$key3].value|h}-->" />
<!--                    <input type="text" name="<!--{$arrForm[$key1].keyname}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->" size="6" class="box6" /> -
                    <input type="text" name="<!--{$arrForm[$key2].keyname}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$arrForm[$key2].length}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->" size="6" class="box6" /> -
                    <input type="text" name="<!--{$arrForm[$key3].keyname}-->" value="<!--{$arrForm[$key3].value|h}-->" maxlength="<!--{$arrForm[$key3].length}-->" style="<!--{$arrErr[$key3]|sfGetErrorColor}-->" size="6" class="box6" />-->
                </td>
            ...
            <tr>
                <th>備考</th>
                <td style="font-size: 17px;line-height: 1.5;color: #f00;"><p style="background-color: #ffc7c7"><!--{$arrForm.message.value|h|nl2br}--></p></td>
            </tr>
            <tr>
                <th>現在ポイント</th>
                <td>
        ...
        <table class="list order-edit-products">
            ...
            <tr>
                ...
                <td class="center">
<!--{if $arrForm.classcategory_name1.value[$product_index]|h == 0}-->
                    <!--{$arrForm.product_name.value[$product_index]|h}-->/<!--{$arrForm.classcategory_name1.value[$product_index]+1}--> day/<!--{$arrForm.classcategory_name2.value[$product_index]|default:"(なし)"|h}-->
<!--{elseif $arrForm.classcategory_name1.value[$product_index]|h > 0}-->
                    <!--{$arrForm.product_name.value[$product_index]|h}-->/<!--{$arrForm.classcategory_name1.value[$product_index]+1}--> days/<!--{$arrForm.classcategory_name2.value[$product_index]|default:"(なし)"|h}-->
<!--{else}-->
        ...
        <!--{foreach name=shipping from=$arrAllShipping item=arrShipping key=shipping_index}-->
            ...
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="attention"><!--{$arrErr[$key2][$shipping_index]}--></span>
                        <span class="attention"><!--{$arrErr[$key3][$shipping_index]}--></span>
                        <select id="shipping_date_year" name="<!--{$key1}-->[<!--{$shipping_index}-->]" style="<!--{$arrErr[$key1][$shipping_index]|sfGetErrorColor}-->">
                            <!--{html_options options=$arrYearShippingDate selected=$arrShipping[$key1]|default:""}-->
                        </select>年
                        <select id="shipping_date_month" name="<!--{$key2}-->[<!--{$shipping_index}-->]" style="<!--{$arrErr[$key2][$shipping_index]|sfGetErrorColor}-->">
                            <!--{html_options options=$arrMonthShippingDate selected=$arrShipping[$key2]|default:""}-->
                        </select>月
                        <select id="shipping_date_day" name="<!--{$key3}-->[<!--{$shipping_index}-->]" style="<!--{$arrErr[$key3][$shipping_index]|sfGetErrorColor}-->">
                            <!--{html_options options=$arrDayShippingDate selected=$arrShipping[$key3]|default:""}-->
                        </select>日
                    		<input type="hidden" id="tmp_shipping_date_year" name="tmp_shipping_date_year">
                    		<input type="hidden" id="tmp_shipping_date_month" name="tmp_shipping_date_month">
                    		<input type="hidden" id="tmp_shipping_date_day" name="tmp_shipping_date_day">
                    </td>
                </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="attention"><!--{$arrErr[$key1]}--></span>
                    <input type="text" id="start_date" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->" size="30" class="box30" readonly/>
                    <input type="hidden" id="tmp_start_date" name="tmp_start_date">
                </td>
            </tr>
            <tr>
                <th>レンタル終了日</th>
                <td>
                    <!--{assign var=key1 value="end_date"}-->
                    <span class="attention"><!--{$arrErr[$key1]}--></span>
                    <input type="text" id="end_date" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->" size="30" class="box30" readonly/>
                    <input type="hidden" id="tmp_end_date" name="tmp_end_date">
                </td>
            </tr>
            <tr>
                <th>レンタル泊数</th>
                <td>
                    <!--{assign var=key1 value="rental_term"}-->
                    <span class="attention"><!--{$arrErr[$key1]}--></span>
                    <input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->" size="30" class="box30" />
                </td>
            </tr>
            <tr style="display: none">
                <th>レンタルフラグ</th>
                <td>
                    <!--{assign var=key1 value="rental_flg"}-->
                    <span class="attention"><!--{$arrErr[$key1]}--></span>
                    <input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->" size="30" class="box30" />
                </td>
            </tr>
            <tr style="display: none">
                <th>延長フラグ</th>
                <td>
                    <!--{assign var=key1 value="extension_flg"}-->
                    <span class="attention"><!--{$arrErr[$key1]}--></span>
                    <input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->" size="30" class="box30" />
                </td>
            </tr>
            <tr style="display: none">
                <th>配送種別</th>
                <td>
                    <!--{assign var=key1 value="receive_flg"}-->
                    <span class="attention"><!--{$arrErr[$key1]}--></span>
                    <input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->" size="30" class="box30" />
                </td>
            </tr>
