...
class LC_Page_Admin_Basis_Tradelaw extends LC_Page_Admin_Ex
{
    ...
    public function lfInitParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('都道府県', 'law_pref', INT_LEN, 'n', array('MAX_LENGTH_CHECK', 'NUM_CHECK'));
        $objFormParam->addParam('所在地1', 'law_addr01', MTEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
        $objFormParam->addParam('所在地2', 'law_addr02', MTEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
        ...
        $objFormParam->addParam('支払期限', 'law_term04', MLTEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
