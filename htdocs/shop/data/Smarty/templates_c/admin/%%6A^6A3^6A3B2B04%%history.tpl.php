<?php /* Smarty version 2.6.27, created on 2022-11-22 17:31:41
         compiled from mail/history.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail/history.tpl', 4, false),array('modifier', 'sfDispDBDate', 'mail/history.tpl', 16, false),array('modifier', 'h', 'mail/history.tpl', 16, false),)), $this); ?>


<form name="form1" id="form1" method="post" action="?">
    <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="search_pageno" value=""><input type="hidden" name="mode" value=""><?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrDataList'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?><div id="mail" class="contents-main">
            <table class="list center"><tr><th>配信開始時刻</th>
                    <th>配信終了時刻</th>
                    <th>Subject</th>
                    <th>プレビュー</th>
                    <th>配信条件</th>
...
" onclick="return window.confirm('配信履歴を削除しても宜しいでしょうか');">削除</a></td>
    ...
    <?php else: ?>
        <div id="complete">
            ...
            <div class="btn-area">
                <ul><li><a class="btn-action" href="./<?php echo ((is_array($_tmp=@DIR_INDEX_PATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
