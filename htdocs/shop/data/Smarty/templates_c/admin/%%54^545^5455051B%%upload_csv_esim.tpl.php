<?php /* Smarty version 2.6.27, created on 2025-06-12 15:50:58
         compiled from products/upload_csv_esim.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/upload_csv_esim.tpl', 5, false),)), $this); ?>
...
"><input type="hidden" name="mode" value="csv_upload"><div id="products" class="contents-main">
...
<br><?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrCSVErr'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<?php if (((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != 'blank'): ?>
            ...
            <?php endif; ?>
            <br><?php endforeach; endif; unset($_from); ?></span>
        </p>
        <?php endif; ?>

        <!--▼登録テーブルここから-->
        <table class="form"><tr><th>CSVファイル</th>
                <td>
...
<br><?php endforeach; endif; unset($_from); ?></td>
            </tr></table><!--▲登録テーブルここまで--><div class="btn-area">
            <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('form1', 'csv_upload', '', ''); return false;"><span class="btn-next">この内容で登録する</span></a></li>
            </ul></div>
...
?>
            ...
            </tr></table><?php endif; ?><?php if (((is_array($_tmp=$this->_tpl_vars['arrRowResult'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><table class="form"><tr><td>
