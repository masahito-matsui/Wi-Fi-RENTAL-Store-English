        ...
        <form name="form1" id="form1" method="post" action="<!--{$smarty.const.ROOT_URLPATH}-->mypage/index.php">
            ...
            <!--{if $objNavi->all_row > 0}-->
                ...
                <div class="information">
                    <p><span class="attention"><span id="historycount"><!--{$objNavi->all_row}--></span></span> Result(s)</p>
                </div>
                        ...
                        <!--{section name=cnt loop=$arrOrder max=$dispNumber}-->
                            ...
                            <div class="arrowBox">
                                <p>
                                    ...
                                    <em>The date of purchase (YYYY/MM/DD): </em><span class="create_date"><!--{$arrOrder[cnt].create_date|sfDispDBDate}--></span><br />
                                    <em>Payment: </em><span class="payment_id"><!--{$arrPayment[$payment_id]|h}--></span><br />
                                    <em>Total amount: </em><span class="payment_total"><!--{$arrOrder[cnt].payment_total|number_format}--> JPY</span><br />
                                    <em>Status: </em>
                ...
                <div class="btn_area">
                    <!--{if $objNavi->all_row > $dispNumber}-->
                        <p><a href="javascript: void(0);" class="btn_more" id="btn_more_history" onClick="getHistory(<!--{$dispNumber}-->); return false;" rel="external">More(＋<!--{$dispNumber}-->)</a></p>
                    <!--{/if}-->
                </div>
            <!--{else}-->
                <div class="form_area">
