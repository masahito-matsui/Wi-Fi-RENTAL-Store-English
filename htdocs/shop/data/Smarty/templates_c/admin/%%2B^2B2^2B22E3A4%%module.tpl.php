<?php /* Smarty version 2.6.27, created on 2022-01-25 11:11:37
         compiled from ownersstore/module.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'ownersstore/module.tpl', 5, false),)), $this); ?>
...
css/thickbox.css" type="text/css" media="screen"><script type="text/javascript" src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
js/ownersstore.js.php"></script><form name="form1" id="form1" method="post" action="?">
