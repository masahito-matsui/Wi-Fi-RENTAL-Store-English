...
<!--                <h3 class="subtitle">お届け時間の指定</h3>-->
        ...
        <!--{else}-->
                <h3 class="subtitle">Delivery Date / Time<br><span style="font-size: 17px;color: #ffee4f;font-style: normal;font-weight: normal;">*The delivery date is the rental starting date.</span></h3>
        <!--{/if}-->
        <!--{if $smarty.session.pre_deliv_id == 4}-->
...
<select name="<!--{$key}-->" id="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->">
  ...
  <!--{section name=cnt start=1  loop=90}-->
  ...
  <!--本島以外-->
    ...
    <option label="<!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%A, %B %e %Y'}-->" value="<!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%Y/%m/%d'}-->"><!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%A, %B %e %Y'}--></option>
    <!--{/if}-->
  <!--{elseif $smarty.session.shipping_airport == 15}-->
  <!--羽田空港のみ-->
    <!--{if $smarty.section.cnt.index == 0}-->
    <!--空港スキップ-->
    <!--{elseif ($smarty.section.cnt.start/$smarty.section.cnt.index) == 1}-->
      <!--17時-->
      <!--{if $smarty.now|date_format:'%H' < 17 }-->
    <option label="<!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%A, %B %e %Y'}-->" value="<!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%Y/%m/%d'}-->"><!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%A, %B %e %Y'}--></option>
      <!--{/if}-->
    ...
    <option label="<!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%A, %B %e %Y'}-->" value="<!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%Y/%m/%d'}-->"><!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%A, %B %e %Y'}--></option>
    <!--{/if}-->
  <!--{elseif $smarty.session.shipping_airport == 2}-->
  <!--成田空港QL1-->
    <!--{if $smarty.section.cnt.index == 0}-->
    <!--空港スキップ-->
    <!--{elseif ($smarty.section.cnt.start/$smarty.section.cnt.index) == 1}-->
    ...
    <option label="<!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%A, %B %e %Y'}-->" value="<!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%Y/%m/%d'}-->"><!--{$smarty.now+86400*$smarty.section.cnt.index|date_format:'%A, %B %e %Y'}--></option>
    <!--{/if}-->
  <!--{elseif $smarty.session.shipping_airport == 5}-->
  <!--成田空港QL2-->
    <!--{if $smarty.section.cnt.index == 0}-->
    <!--空港スキップ-->
    <!--{elseif ($smarty.section.cnt.start/$smarty.section.cnt.index) == 1}-->
...
<!--★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★-->
        ...
        <!--{elseif $smarty.session.pre_deliv_id == 3}-->
                <p style="font-size:13px; color:#333; line-height:17px;">*When the selected delivery place is airports and the order is placed in advance,the parcel will be delivered one day earlier.</p>
        <!--{else}-->
                <p class="attention"></p>
        <!--{/if}-->
        ...
        <section class="contact_area">
            ...
            <div class="form_area">
                <p class="normal" style="color:#f00">※The person who request for a pickup at airports.<br>
