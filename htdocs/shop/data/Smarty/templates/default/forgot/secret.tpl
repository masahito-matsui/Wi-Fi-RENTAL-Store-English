...
<div id="window_area">
    <h2>Password Hint</h2>
    <p class="information">
        * If you forget your answer for the following question, please contact us at: <br><a href="mailto:<!--{$arrSiteInfo.email02|escape:'hex'}-->"><!--{$arrSiteInfo.email02|escape:'hexentitiy'}--></a><br />
    </p>
    <p class="message">
