...
class PgMulpayUtils extends SC_Plugin_Base {
    ...
    function install($arrPlugin) {
        // 必要なファイルをコピーします.
        if (is_file(MDL_PG_MULPAY_PATH . "media/logo.png")) {
    ...
    function enable($arrPlugin) {
        ...
        copy(PLUGIN_UPLOAD_REALDIR . "PgMulpayUtils/admin/plg_pgmulpayutils_use_limit_unlock.php", HTML_REALDIR . ADMIN_DIR . "order/plg_pgmulpayutils_use_limit_unlock.php");
