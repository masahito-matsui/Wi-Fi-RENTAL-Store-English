<?php /* Smarty version 2.6.27, created on 2025-11-20 16:08:08
         compiled from basis/holiday.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/holiday.tpl', 4, false),array('modifier', 'h', 'basis/holiday.tpl', 9, false),array('modifier', 'sfGetErrorColor', 'basis/holiday.tpl', 9, false),array('function', 'html_options', 'basis/holiday.tpl', 18, false),)), $this); ?>


<form name="form1" id="form1" method="post" action="?">
    <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value="edit"><input type="hidden" name="holiday_id" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['tpl_holiday_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><div id="basis" class="contents-main">

        <table class="form"><tr><th>タイトル<span class="attention"> *</span></th>
                <td>
...
" size="60" class="box60"><span class="attention"> (上限<?php echo ((is_array($_tmp=@SMTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
                </td>
            </tr><tr><th>日付<span class="attention"> *</span></th>
                <td>
...
"><option value="">--</option><?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrDay'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['day']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
                    ...
                    <br><span class="attention">振替休日は自動設定されないので、振替え先の日付を設定してください。</span>
                </td>
        ...
        <table class="list"><col width="50%"><col width="20%"><col width="10%"><col width="10%"><col width="20%"><tr><th>タイトル</th>
                <th>日付</th>
                <th class="edit">編集</th>
...
<?php endif; ?>;"><?php $this->assign('holiday_id', ((is_array($_tmp=$this->_tpl_vars['arrHoliday'][$this->_sections['cnt']['index']]['holiday_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))); ?><td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrHoliday'][$this->_sections['cnt']['index']]['title'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
