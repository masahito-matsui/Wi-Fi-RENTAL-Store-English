...
require_once PLUGIN_UPLOAD_REALDIR . "ExpressLink/class/plg_ExpressLink_LC_Page_Shopping_Payment.php";

class plg_ExpressLink_LC_Page_Shopping_Payment_Ex extends plg_ExpressLink_LC_Page_Shopping_Payment
{
