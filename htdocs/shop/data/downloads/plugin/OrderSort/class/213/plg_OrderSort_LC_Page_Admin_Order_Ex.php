...
require_once PLUGIN_UPLOAD_REALDIR . "OrderSort/class/plg_OrderSort_LC_Page_Admin_Order.php";

class plg_OrderSort_LC_Page_Admin_Order_Ex extends plg_OrderSort_LC_Page_Admin_Order{
    /**
