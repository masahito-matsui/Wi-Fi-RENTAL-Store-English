...
<!--{strip}-->
    ...
    <col width="70%" />
    <tr>
        <th>Name<span class="attention">*</span><br>
             <p class="attention_normal"><span class="attention mini">For hotel deliveries,</span> the recipient name must match the hotel reservation name.</p></th>
        <td>
            <!--{assign var=key1 value="`$prefix`name01"}-->
            <!--{assign var=key2 value="`$prefix`name02"}-->
            <!--{if $arrErr[$key1] || $arrErr[$key2]}-->
                <div class="attention" style="background-color:#FFBCBD"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></div>
            <!--{/if}-->
            <input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->; ime-mode: disabled;" class="box300" />
            <!--First name&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$arrForm[$key2].length}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->; ime-mode: disabled;" class="box120" />-->
            <p class="mini gray">Please enter alphabetic characters only.</p>
        </td>
    </tr>
    <!--<tr>
        ...
        <td>
            ...
            <!--{if $arrErr[$key1] || $arrErr[$key2]}-->
                <div class="attention" style="background-color:#FFBCBD"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></div>
            <!--{/if}-->
            セイ&nbsp;<input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->; ime-mode: disabled;" class="box120" />&nbsp;
            メイ&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->; ime-mode: disabled;" class="box120" />
        </td>
    </tr>-->
    ...
    <!--{else}-->
    <input type="hidden" name="<!--{$key6}-->" value="392" />
    <!--<tr>
        <th>Country<span class="attention">※</span></th>
        <td>
            <!--{if $arrErr[$key6]}-->
                <div class="attention" style="background-color:#FFBCBD"><!--{$arrErr[$key6]}--></div>
            <!--{/if}-->
    ...
    <tr>
        <th>Post Code<span class="attention">*</span></th>
        <td>
            〒<!--{if $arrErr[$key7]}-->
                <div class="attention" style="background-color:#FFBCBD"><!--{$arrErr[$key7]}--></div>
            <!--{/if}-->
    ...
    <!--{/if}-->
    <tr>
        <th>Postal Code<span class="attention">*</span><!--{if !$smarty.const.FORM_COUNTRY_ENABLE}--><!--{/if}--></th>
        <td>
            <!--{if $arrErr[$key1] || $arrErr[$key2]}-->
                <div class="attention" style="background-color:#FFBCBD"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></div>
            <!--{/if}-->
            <p class="top">〒&nbsp;<input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60 zip01" />&nbsp;-&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$arrForm[$key2].length}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60 zip02" />&nbsp;
            <!--<a href="http://search.post.japanpost.jp/zipcode/" target="_blank"><span class="mini">Zip Code Search</span></a>-->
            <div class="attention_normal">If you don't know the postal code, please enter 000-0000.</div>
            </p>
            <!--<p class="zipimg">
    ...
    <tr>
        ...
        <td>
            <!--{if $arrErr[$key3] || $arrErr[$key4] || $arrErr[$key5]}-->
                <div class="attention" style="background-color:#FFBCBD"><!--{$arrErr[$key3]}--><!--{$arrErr[$key4]}--><!--{$arrErr[$key5]}--></div>
            <!--{/if}-->
            ...
            <p class="top"><input type="text" name="<!--{$key4}-->" value="<!--{$arrForm[$key4].value|h}-->" class="box300" style="<!--{$arrErr[$key4]|sfGetErrorColor}-->; ime-mode: disabled;" /><br />
                Address1 <!--{$smarty.const.SAMPLE_ADDRESS1}--></p>
            <p class="top"><input type="text" name="<!--{$key5}-->" value="<!--{$arrForm[$key5].value|h}-->" class="box300" style="<!--{$arrErr[$key5]|sfGetErrorColor}-->; ime-mode: disabled;" /><br />
                Address2 <!--{$smarty.const.SAMPLE_ADDRESS2}--></p>
            <p class="mini"><span class="attention"><!--住所は2つに分けてご記入ください。マンション名は必ず記入してください。--></span></p>
        </td>
    </tr>
    		<!--{if $smarty.session.pre_deliv_id == 1}-->
        <tr>
        <th>Hotel name / Host name of Airbnb / Home Owner's Name<br>
               <p class="attention_normal mini">If you receive your rental device <span class="attention">at your hotel</span>, please enter the name of your hotel.</p>
               <p class="attention_normal mini">If you receive your rental device <span class="attention">at your Airbnb</span>, please enter the home owner's full name.</p>
               <p class="attention_normal mini">If you receive your rental device <span class="attention">at your friend or family's home</span>, please enter the home owner's full name.</p></th>
        <td>
            ...
            <!--{/if}-->
    <tr>
        <th>Phone<span class="attention">*</span></th>
        <td>
    ...
    <tr>
        ...
        <td>
            ...
            <!--{if $arrErr[$key1] || $arrErr[$key2] || $arrErr[$key3]}-->
                <div class="attention" style="background-color:#FFBCBD"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--><!--{$arrErr[$key3]}--></div>
            <!--{/if}-->
    ...
    <!--{if $flgFields > 1}-->
        <tr>
            ...
            <td>
                ...
                <span class="attention mini">Please fill in twice to make sure</span>
            </td>
        </tr>
        <!--{if $emailMobile}-->
            <tr>
...
<!--			<option value="0" selected="selected">選択してください</option>-->
			...
			<input type="hidden" name="<!--{$key2}-->" value="9999" maxlength="<!--{$arrForm[$key2].length}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />
			<input type="hidden" name="<!--{$key3}-->" value="9999" maxlength="<!--{$arrForm[$key3].length}-->" style="<!--{$arrErr[$key3]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />
        </td>
    </tr>
			<!--{elseif $smarty.session.pre_deliv_id == 5}-->
        <tr>
        <th>Router number<span class="attention">*</span></th>
        <td>
            <!--{assign var=key1 value="`$prefix`company_name"}-->
            <!--{if $arrErr[$key1]}-->
                <div class="attention" style="background-color:#FFBCBD"><!--{$arrErr[$key1]}--></div>
            <!--{/if}-->
            <input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$arrForm[$key1].length}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->; ime-mode: disabled;" class="box300" /></br>
         <span class="attention mini">[To person who order for extension]</br>
         Pleae key in present terminal number that begins with YM- EM- WM- au- SB-...</span>   
        </td>
			<!--{/if}-->
        ...
        <tr>
            ...
            <td>
                ...
                <!--{if $errBirth}-->
                    <div class="attention" style="background-color:#FFBCBD"><!--{$errBirth}--></div>
                <!--{/if}-->
        ...
        <!--{if $flgFields > 2}-->
            ...
            <tr>
                ...
                <td>
                    ...
                    <br />
                    答え：<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->; ime-mode: disabled;" class="box260" />
                </td>
            </tr>
            <tr>
