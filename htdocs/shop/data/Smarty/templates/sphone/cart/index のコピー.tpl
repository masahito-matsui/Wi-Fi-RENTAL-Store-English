...
<p class="only_ext"><input type="radio" name="deliv_id" id="airport" value="3"><label for="airport">Post office inside airport　*540 yen is added to delivery fee</label></p>
