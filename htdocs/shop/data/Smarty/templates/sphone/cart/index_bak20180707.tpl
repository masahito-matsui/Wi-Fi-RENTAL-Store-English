...
<label for="airport"><p class="method_name">Pickup at airport</p>
<p class="method_text">*540 yen is added to delivery fee<span class="s_text">(Please enter " flight number " and " estimated arrival time " for flight in remarks column on the next page.)</span></p>
</label></div>

<div class="only_ext">
<input type="radio" name="deliv_id" id="normal" value="1">
<label for="normal"><p class="method_name">Hotels, Your Stay (Air bnb,Friend's house, etc)</p>
<p class="method_text">*Item is delivered by Yu-pack</p></label></div>

<div class="only_ext">
<input type="radio" name="deliv_id" id="storefront" value="4">
<label for="storefront"><p class="method_name">Pickup at our store</p>
<p class="method_text">*5 minutes on foot from Akihabara station　(Business hours 11:00 to 19:00 / weekday only)</p></label></div>

<div class="only_ext">
<input type="radio" name="deliv_id" id="extension" value="5">
<label for="extension"><p class="method_name">Order for extension of rental</p>
<p class="method_text">*This is for our consumers who are using right now.</p></label></div>

<div class="only_ext2">
<input type="radio" name="deliv_id" id="extension2" value="5" checked="checked">
<label for="extension2"><p class="method_name">Order for extension of rental</p>
<p class="method_text">*This is for our consumers who are using right now.</p></label></div>
...
.terms_box p a {
    ...
    <div class="terms_box">
     <p>Please agree with Terms and Conditions and proceed to "next"</p>
