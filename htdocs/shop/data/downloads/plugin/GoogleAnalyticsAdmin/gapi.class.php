...
class gapi
{
  ...
  protected function accountObjectMapper($xml_string)
  {
    ...
    if (isset($google_results->startDate)) $account_root_parameters['startDate'] = strval($google_results->startDate);
    if (isset($google_results->endDate)) $account_root_parameters['endDate'] = strval($google_results->endDate);
