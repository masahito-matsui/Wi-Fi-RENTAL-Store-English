...
<section id="slidewindow">
    ...
    <form name="login_mypage" id="login_mypage" method="post" action="javascript:;" onsubmit="return ajaxLogin();">
        ...
        <div class="login_area">
            ...
            <div class="loginareaBox">
                ...
                <input type="email" name="<!--{$key}-->" value="<!--{$tpl_login_email|h}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" class="mailtextBox data-role-none" placeholder="Email" />
            ...
            <p class="arrowRtxt"><a rel="external" href="<!--{$smarty.const.HTTPS_URL}-->forgot/<!--{$smarty.const.DIR_INDEX_PATH}-->">Forgot your password?</a></p>

            <div class="btn_area">
                <input type="submit" value="Sign in" class="btn data-role-none" name="log" id="log" />
            </div>
        </div><!-- /.login_area -->
    </form>
    ...
    <form name="member_form2" id="member_form2" method="post" action="?">
        ...
        <div class="login_area_btm">
            <nav>
                <ul class="navBox">
                    <li><a rel="external" href="<!--{$smarty.const.ROOT_URLPATH}-->entry/">Sign up</a></li>
                </ul>
            </nav>
            <p>You can use convenient "My page" after enrolling as member.</p>
        </div>
    </form>
</section>
