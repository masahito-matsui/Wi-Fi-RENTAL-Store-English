<?php /* Smarty version 2.6.27, created on 2024-01-24 10:36:01
         compiled from /data/en.wifi-rental-store.jp/htdocs/shop/data/downloads/module/mdl_pg_mulpay/templates/admin/config.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/data/en.wifi-rental-store.jp/htdocs/shop/data/downloads/module/mdl_pg_mulpay/templates/admin/config.tpl', 111, false),array('modifier', 'h', '/data/en.wifi-rental-store.jp/htdocs/shop/data/downloads/module/mdl_pg_mulpay/templates/admin/config.tpl', 113, false),array('modifier', 'escape', '/data/en.wifi-rental-store.jp/htdocs/shop/data/downloads/module/mdl_pg_mulpay/templates/admin/config.tpl', 135, false),array('modifier', 'sfGetErrorColor', '/data/en.wifi-rental-store.jp/htdocs/shop/data/downloads/module/mdl_pg_mulpay/templates/admin/config.tpl', 161, false),array('function', 'html_radios', '/data/en.wifi-rental-store.jp/htdocs/shop/data/downloads/module/mdl_pg_mulpay/templates/admin/config.tpl', 152, false),array('function', 'html_checkboxes', '/data/en.wifi-rental-store.jp/htdocs/shop/data/downloads/module/mdl_pg_mulpay/templates/admin/config.tpl', 223, false),)), $this); ?>
...
function payment_select() {
    var is_token = 0;
    $("input:checkbox[name='enable_payment_type[]']:checked").each(function() {
        if ($(this).val() == "98") {
            // トークン方式クレジットカード決済が選択されている
            is_token = 1;
        }
    });

    if (is_token == 0) {
        $("input:checkbox[name='enable_payment_type[]']").each(function() {
            if ($(this).val() == "10") {
...
$(function(){
    ...
    payment_select();
    $("input:checkbox[name='enable_payment_type[]']").change(function() {
        payment_select();
    });
});
//-->
...
<a href="http://www.gmo-pg.com/?argument=2qpV46CP&dmai=a5177c923cb929" target="_blank" onmouseover="chgImg('<?php echo ((is_array($_tmp=@MDL_PG_MULPAY_MEDIAFILE_URL)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
<a href="https://service.gmo-pg.com/cyllene/entry/trialStart.htm?argument=2qpV46CP&dmai=a5177c98d5464d" target="_blank" onmouseover="chgImg('<?php echo ((is_array($_tmp=@MDL_PG_MULPAY_MEDIAFILE_URL)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
