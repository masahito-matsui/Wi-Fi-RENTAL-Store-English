<?php /* Smarty version 2.6.27, created on 2022-01-30 12:14:52
         compiled from system/system.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'system/system.tpl', 4, false),array('modifier', 'h', 'system/system.tpl', 5, false),array('modifier', 'nl2br', 'system/system.tpl', 8, false),)), $this); ?>


<h2>概要</h2>
<table border="0" cellspacing="1" cellpadding="8" summary=" "><?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrSystemInfo'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
?><tr><th>
        ...
        </tr><?php endforeach; endif; unset($_from); ?></table><h2>PHP情報</h2>
