<?php /* Smarty version 2.6.27, created on 2022-04-10 11:37:12
         compiled from system/bkup.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'system/bkup.tpl', 12, false),array('modifier', 'h', 'system/bkup.tpl', 22, false),array('modifier', 'sfCutString', 'system/bkup.tpl', 46, false),)), $this); ?>
...
"><input type="hidden" name="mode" value="edit"><input type="hidden" name="list_name" value=""><div id="system" class="contents-main">
        <p class="remark">
            データベースのバックアップを行います。<br>
            テンプレートファイル等はバックアップされません。
        </p>
        <table class="form"><tr><th>バックアップ名<span class="attention"> *</span></th>
                <td>
...
</textarea><span class="attention"> (上限<?php echo ((is_array($_tmp=@MTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
                </td>
            </tr></table><div class="btn"><a class="btn-normal" href="javascript:;" name="cre_bkup" onclick="document.body.style.cursor = 'wait'; form1.mode.value='bkup'; document.form1.submit(); return false;"><span>バックアップデータを作成する</span></a></div>
...
</span><br><?php endif; ?><?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrBkupList'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?><table class="list"><tr><th>バックアップ名</th>
                    <th>バックアップメモ</th>
                    <th>作成日</th>
                    <th>リストア</th>
                    <th>ダウンロード</th>
...
?><tr><td><?php echo ((is_array($_tmp=$this->_tpl_vars['arrBkupList'][$this->_sections['cnt']['index']]['bkup_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</td>
...
'); return false;">削除</a>
                    ...
                    </tr><?php endfor; endif; ?></table><?php endif; ?><?php if (strlen ( ((is_array($_tmp=$this->_tpl_vars['tpl_restore_msg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) >= 1): ?><h2>実行結果</h2>
            <div class="message">
